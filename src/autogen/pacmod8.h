...
// DBC file version
#define VER_PACMOD8_MAJ (0U)
#define VER_PACMOD8_MIN (0U)

// include current dbc-driver compilation config
#include "pacmod8-config.h"
...
typedef struct
{
  ...
  //  1 : "APPLIED"
  //  2 : "UNAPPLIED"
  uint8_t CABIN_EBRAKE_OPCTRL : 2;           //      Bits= 2
  ...
  //  1 : "APPLIED"
  //  2 : "UNAPPLIED"
  uint8_t CABIN_EBRAKE_OPCTRL;               //      Bits= 2
...
typedef struct
{
  ...
  //  0 : "APPLY_BRAKE"
  //  1 : "RELEASE_BRAKE"
  uint8_t REPORTED_VALUE : 1;                //      Bits= 1
...
typedef struct
{
  ...
  //  0 : "APPLY_BRAKE"
  //  1 : "RELEASE_BRAKE"
  uint8_t COMMAND : 1;                       //      Bits= 1

#else

  //  0 : "APPLY_BRAKE"
  //  1 : "RELEASE_BRAKE"
  uint8_t COMMAND;                           //      Bits= 1
...
// signal: @ACCEL_CMD_ro
#define PACMOD8_ACCEL_CMD_ro_CovFactor (0.001000)
#define PACMOD8_ACCEL_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_ACCEL_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @BRAKE_CMD_ro
#define PACMOD8_BRAKE_CMD_ro_CovFactor (0.001000)
#define PACMOD8_BRAKE_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_BRAKE_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @POSITION_ro
#define PACMOD8_POSITION_ro_CovFactor (0.001000)
#define PACMOD8_POSITION_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_POSITION_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROTATION_RATE_ro
#define PACMOD8_ROTATION_RATE_ro_CovFactor (0.001000)
#define PACMOD8_ROTATION_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_ROTATION_RATE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_BRAKE_DECCEL_CMD_ro_CovFactor (0.001000)
#define PACMOD8_BRAKE_DECCEL_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_BRAKE_DECCEL_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_CABIN_TEMP_CMD_ro_CovFactor (0.100000)
#define PACMOD8_CABIN_TEMP_CMD_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD8_CABIN_TEMP_CMD_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
...
typedef struct
{
  ...
  uint8_t CABIN_TEMP_CMD_ro;                 //      Bits= 8 Offset= 10.000000          Factor= 0.100000       
...
#define PACMOD8_MANUAL_INPUT_ro_CovFactor (0.001000)
#define PACMOD8_MANUAL_INPUT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_MANUAL_INPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @COMMANDED_VALUE_ro
#define PACMOD8_COMMANDED_VALUE_ro_CovFactor (0.001000)
#define PACMOD8_COMMANDED_VALUE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_COMMANDED_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @OUTPUT_VALUE_ro
#define PACMOD8_OUTPUT_VALUE_ro_CovFactor (0.001000)
#define PACMOD8_OUTPUT_VALUE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_OUTPUT_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_ACCEL_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD8_ACCEL_CMD_LIMIT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_ACCEL_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_ACCEL_CMD_ro
#define PACMOD8_LIMITED_ACCEL_CMD_ro_CovFactor (0.001000)
#define PACMOD8_LIMITED_ACCEL_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_LIMITED_ACCEL_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_BRAKE_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD8_BRAKE_CMD_LIMIT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_BRAKE_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_BRAKE_CMD_ro
#define PACMOD8_LIMITED_BRAKE_CMD_ro_CovFactor (0.001000)
#define PACMOD8_LIMITED_BRAKE_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_LIMITED_BRAKE_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @MANUAL_INPUT_ro
#define PACMOD8_MANUAL_INPUT_ro_CovFactor (0.001000)
#define PACMOD8_MANUAL_INPUT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_MANUAL_INPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @COMMANDED_VALUE_ro
#define PACMOD8_COMMANDED_VALUE_ro_CovFactor (0.001000)
#define PACMOD8_COMMANDED_VALUE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_COMMANDED_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @OUTPUT_VALUE_ro
#define PACMOD8_OUTPUT_VALUE_ro_CovFactor (0.001000)
#define PACMOD8_OUTPUT_VALUE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_OUTPUT_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_POSITION_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD8_POSITION_CMD_LIMIT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_POSITION_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_POSITION_CMD_ro
#define PACMOD8_LIMITED_POSITION_CMD_ro_CovFactor (0.001000)
#define PACMOD8_LIMITED_POSITION_CMD_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_LIMITED_POSITION_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROTATION_RATE_CMD_LIMIT_ro
#define PACMOD8_ROTATION_RATE_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD8_ROTATION_RATE_CMD_LIMIT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_ROTATION_RATE_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_ROTATION_RATE_ro
#define PACMOD8_LIMITED_ROTATION_RATE_ro_CovFactor (0.001000)
#define PACMOD8_LIMITED_ROTATION_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_LIMITED_ROTATION_RATE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @MANUAL_INPUT_ro
#define PACMOD8_MANUAL_INPUT_ro_CovFactor (0.100000)
#define PACMOD8_MANUAL_INPUT_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD8_MANUAL_INPUT_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
// signal: @COMMANDED_VALUE_ro
#define PACMOD8_COMMANDED_VALUE_ro_CovFactor (0.100000)
#define PACMOD8_COMMANDED_VALUE_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD8_COMMANDED_VALUE_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
// signal: @OUTPUT_VALUE_ro
#define PACMOD8_OUTPUT_VALUE_ro_CovFactor (0.100000)
#define PACMOD8_OUTPUT_VALUE_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD8_OUTPUT_VALUE_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
...
typedef struct
{
  ...
  uint8_t MANUAL_INPUT_ro;                   //      Bits= 8 Offset= 10.000000          Factor= 0.100000       

#ifdef PACMOD8_USE_SIGFLOAT
  sigfloat_t MANUAL_INPUT_phys;
#endif // PACMOD8_USE_SIGFLOAT

  uint8_t COMMANDED_VALUE_ro;                //      Bits= 8 Offset= 10.000000          Factor= 0.100000       

#ifdef PACMOD8_USE_SIGFLOAT
  sigfloat_t COMMANDED_VALUE_phys;
#endif // PACMOD8_USE_SIGFLOAT

  uint8_t OUTPUT_VALUE_ro;                   //      Bits= 8 Offset= 10.000000          Factor= 0.100000       
...
#define PACMOD8_RAW_PEDAL_POS_ro_CovFactor (0.001000)
#define PACMOD8_RAW_PEDAL_POS_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_RAW_PEDAL_POS_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @RAW_PEDAL_FORCE_ro
#define PACMOD8_RAW_PEDAL_FORCE_ro_CovFactor (0.001000)
#define PACMOD8_RAW_PEDAL_FORCE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_RAW_PEDAL_FORCE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PARKING_BRAKE_AUX_RPT_CYC (250U)
...
#define PACMOD8_RAW_POSITION_ro_CovFactor (0.001000)
#define PACMOD8_RAW_POSITION_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_RAW_POSITION_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @RAW_TORQUE_ro
#define PACMOD8_RAW_TORQUE_ro_CovFactor (0.001000)
#define PACMOD8_RAW_TORQUE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_RAW_TORQUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROTATION_RATE_ro
#define PACMOD8_ROTATION_RATE_ro_CovFactor (0.001000)
#define PACMOD8_ROTATION_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_ROTATION_RATE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_VEHICLE_SPEED_ro_CovFactor (0.010000)
#define PACMOD8_VEHICLE_SPEED_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_VEHICLE_SPEED_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
#define PACMOD8_MOTOR_CURRENT_ro_CovFactor (0.001000)
#define PACMOD8_MOTOR_CURRENT_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_MOTOR_CURRENT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @SHAFT_POSITION_ro
#define PACMOD8_SHAFT_POSITION_ro_CovFactor (0.001000)
#define PACMOD8_SHAFT_POSITION_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_SHAFT_POSITION_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_ANGULAR_SPEED_ro_CovFactor (0.100000)
#define PACMOD8_ANGULAR_SPEED_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.100000)) )
#define PACMOD8_ANGULAR_SPEED_ro_fromS(x) ( (((x) * (0.100000)) + (0.000000)) )
...
#define PACMOD8_TORQUE_OUTPUT_ro_CovFactor (0.001000)
#define PACMOD8_TORQUE_OUTPUT_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_TORQUE_OUTPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @TORQUE_INPUT_ro
#define PACMOD8_TORQUE_INPUT_ro_CovFactor (0.001000)
#define PACMOD8_TORQUE_INPUT_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_TORQUE_INPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_WHEEL_SPD_FRONT_LEFT_ro_CovFactor (0.010000)
#define PACMOD8_WHEEL_SPD_FRONT_LEFT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_WHEEL_SPD_FRONT_LEFT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @WHEEL_SPD_FRONT_RIGHT_ro
#define PACMOD8_WHEEL_SPD_FRONT_RIGHT_ro_CovFactor (0.010000)
#define PACMOD8_WHEEL_SPD_FRONT_RIGHT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_WHEEL_SPD_FRONT_RIGHT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @WHEEL_SPD_REAR_LEFT_ro
#define PACMOD8_WHEEL_SPD_REAR_LEFT_ro_CovFactor (0.010000)
#define PACMOD8_WHEEL_SPD_REAR_LEFT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_WHEEL_SPD_REAR_LEFT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @WHEEL_SPD_REAR_RIGHT_ro
#define PACMOD8_WHEEL_SPD_REAR_RIGHT_ro_CovFactor (0.010000)
#define PACMOD8_WHEEL_SPD_REAR_RIGHT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_WHEEL_SPD_REAR_RIGHT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @YAW_RATE_ro
#define PACMOD8_YAW_RATE_ro_CovFactor (0.010000)
#define PACMOD8_YAW_RATE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_YAW_RATE_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @HEADING_ro
#define PACMOD8_HEADING_ro_CovFactor (0.010000)
#define PACMOD8_HEADING_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_HEADING_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @DATE_YEAR_ro
#define PACMOD8_DATE_YEAR_ro_CovFactor (1)
#define PACMOD8_DATE_YEAR_ro_toS(x) ( (uint8_t) ((x) - (2000)) )
#define PACMOD8_DATE_YEAR_ro_fromS(x) ( ((x) + (2000)) )
// signal: @DATE_MONTH_ro
#define PACMOD8_DATE_MONTH_ro_CovFactor (1)
#define PACMOD8_DATE_MONTH_ro_toS(x) ( (uint8_t) ((x) - (1)) )
#define PACMOD8_DATE_MONTH_ro_fromS(x) ( ((x) + (1)) )
// signal: @DATE_DAY_ro
#define PACMOD8_DATE_DAY_ro_CovFactor (1)
#define PACMOD8_DATE_DAY_ro_toS(x) ( (uint8_t) ((x) - (1)) )
#define PACMOD8_DATE_DAY_ro_fromS(x) ( ((x) + (1)) )
...
#define PACMOD8_ENGINE_SPEED_ro_CovFactor (0.250000)
#define PACMOD8_ENGINE_SPEED_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.250000)) )
#define PACMOD8_ENGINE_SPEED_ro_fromS(x) ( (((x) * (0.250000)) + (0.000000)) )
// signal: @ENGINE_TORQUE_ro
#define PACMOD8_ENGINE_TORQUE_ro_CovFactor (0.062500)
#define PACMOD8_ENGINE_TORQUE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.062500)) )
#define PACMOD8_ENGINE_TORQUE_ro_fromS(x) ( (((x) * (0.062500)) + (0.000000)) )
// signal: @ENGINE_COOLANT_TEMP_ro
#define PACMOD8_ENGINE_COOLANT_TEMP_ro_CovFactor (1)
#define PACMOD8_ENGINE_COOLANT_TEMP_ro_toS(x) ( (uint8_t) ((x) - (-40)) )
#define PACMOD8_ENGINE_COOLANT_TEMP_ro_fromS(x) ( ((x) + (-40)) )
// signal: @FUEL_LEVEL_ro
#define PACMOD8_FUEL_LEVEL_ro_CovFactor (0.005000)
#define PACMOD8_FUEL_LEVEL_ro_toS(x) ( (uint8_t) (((x) - (0.000000)) / (0.005000)) )
#define PACMOD8_FUEL_LEVEL_ro_fromS(x) ( (((x) * (0.005000)) + (0.000000)) )
...
#define PACMOD8_FRONT_OBJECT_DISTANCE_LOW_RES_ro_CovFactor (0.001000)
#define PACMOD8_FRONT_OBJECT_DISTANCE_LOW_RES_ro_toS(x) ( (uint32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_FRONT_OBJECT_DISTANCE_LOW_RES_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @FRONT_OBJECT_DISTANCE_HIGH_RES_ro
#define PACMOD8_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_CovFactor (0.001000)
#define PACMOD8_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_toS(x) ( (uint32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_VEH_G_FORCES_ro_CovFactor (0.001000)
#define PACMOD8_VEH_G_FORCES_ro_toS(x) ( (uint8_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_VEH_G_FORCES_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_LATERAL_ACCEL_ro_CovFactor (0.010000)
#define PACMOD8_LATERAL_ACCEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_LATERAL_ACCEL_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @LONGITUDNAL_ACCEL_ro
#define PACMOD8_LONGITUDNAL_ACCEL_ro_CovFactor (0.010000)
#define PACMOD8_LONGITUDNAL_ACCEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_LONGITUDNAL_ACCEL_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @VERTICAL_ACCEL_ro
#define PACMOD8_VERTICAL_ACCEL_ro_CovFactor (0.010000)
#define PACMOD8_VERTICAL_ACCEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD8_VERTICAL_ACCEL_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @PITCH_VEL_ro
#define PACMOD8_PITCH_VEL_ro_CovFactor (0.001000)
#define PACMOD8_PITCH_VEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_PITCH_VEL_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROLL_VEL_ro
#define PACMOD8_ROLL_VEL_ro_CovFactor (0.001000)
#define PACMOD8_ROLL_VEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_ROLL_VEL_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @YAW_VEL_ro
#define PACMOD8_YAW_VEL_ro_CovFactor (0.001000)
#define PACMOD8_YAW_VEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD8_YAW_VEL_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD8_FRONT_LEFT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD8_FRONT_LEFT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD8_FRONT_LEFT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
// signal: @FRONT_RIGHT_TIRE_PRESSURE_ro
#define PACMOD8_FRONT_RIGHT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD8_FRONT_RIGHT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD8_FRONT_RIGHT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
// signal: @REAR_LEFT_TIRE_PRESSURE_ro
#define PACMOD8_REAR_LEFT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD8_REAR_LEFT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD8_REAR_LEFT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
// signal: @REAR_RIGHT_TIRE_PRESSURE_ro
#define PACMOD8_REAR_RIGHT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD8_REAR_RIGHT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD8_REAR_RIGHT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
...
// def @TRACTION_CONTROL_RPT CAN Message (1055 0x41f)
#define TRACTION_CONTROL_RPT_IDE (0U)
#define TRACTION_CONTROL_RPT_DLC (2U)
#define TRACTION_CONTROL_RPT_CANID (0x41f)
#define TRACTION_CONTROL_RPT_CYC (100U)
...
} TRACTION_CONTROL_RPT_t;

// def @ANTILOCK_BRAKE_RPT CAN Message (1056 0x420)
#define ANTILOCK_BRAKE_RPT_IDE (0U)
#define ANTILOCK_BRAKE_RPT_DLC (2U)
#define ANTILOCK_BRAKE_RPT_CANID (0x420)
#define ANTILOCK_BRAKE_RPT_CYC (100U)
