...
/* #define PACMOD9_USE_BITS_SIGNAL */
...
/* #define PACMOD9_USE_DIAG_MONITORS */


/* ------------------------------------------------------------------------- *
  When monitor using is enabled (PACMOD9_USE_DIAG_MONITORS) and define below
