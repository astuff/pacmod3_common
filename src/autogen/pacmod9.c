...
#ifdef PACMOD9_USE_DIAG_MONITORS
// Function prototypes to be called each time CAN frame is unpacked
// FMon function may detect RC, CRC or DLC violation
#include "pacmod9-fmon.h"

#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Unpack_GLOBAL_RPT_pacmod9(GLOBAL_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_GLOBAL_RPT_pacmod9(&_m->mon1, GLOBAL_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS

  return GLOBAL_RPT_CANID;
}

#ifdef PACMOD9_USE_CANSTRUCT

uint32_t Pack_GLOBAL_RPT_pacmod9(GLOBAL_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_GLOBAL_RPT_pacmod9(GLOBAL_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
#endif // PACMOD9_USE_CANSTRUCT

uint32_t Unpack_GLOBAL_RPT_2_pacmod9(GLOBAL_RPT_2_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_GLOBAL_RPT_2_pacmod9(&_m->mon1, GLOBAL_RPT_2_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_GLOBAL_RPT_2_pacmod9(GLOBAL_RPT_2_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < GLOBAL_RPT_2_DLC) && (i < 8); cframe->Data[i++] = 0);

  cframe->Data[0] |= (_m->SYSTEM_ENABLED & (0x01U)) | ((_m->SYSTEM_OVERRIDE_ACTIVE & (0x01U)) << 1) | ((_m->SYSTEM_FAULT_ACTIVE & (0x01U)) << 2) | ((_m->SUPERVISORY_ENABLE_REQUIRED & (0x01U)) << 3);
...
uint32_t Pack_GLOBAL_RPT_2_pacmod9(GLOBAL_RPT_2_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < GLOBAL_RPT_2_DLC) && (i < 8); _d[i++] = 0);

  _d[0] |= (_m->SYSTEM_ENABLED & (0x01U)) | ((_m->SYSTEM_OVERRIDE_ACTIVE & (0x01U)) << 1) | ((_m->SYSTEM_FAULT_ACTIVE & (0x01U)) << 2) | ((_m->SUPERVISORY_ENABLE_REQUIRED & (0x01U)) << 3);
...
uint32_t Unpack_COMPONENT_RPT_00_pacmod9(COMPONENT_RPT_00_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_COMPONENT_RPT_00_pacmod9(&_m->mon1, COMPONENT_RPT_00_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_COMPONENT_RPT_00_pacmod9(COMPONENT_RPT_00_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  ...
  cframe->Data[2] |= (_m->STEERING & (0x01U)) | ((_m->TURN & (0x01U)) << 1) | ((_m->WIPER & (0x01U)) << 2) | ((_m->WATCHDOG & (0x01U)) << 3) | ((_m->BRAKE_DECCEL & (0x01U)) << 4) | ((_m->REAR_PASS_DOOR & (0x01U)) << 5) | ((_m->ENGINE_BRAKE & (0x01U)) << 6) | ((_m->MARKER_LAMP & (0x01U)) << 7);
  cframe->Data[3] |= (_m->CABIN_CLIMATE & (0x01U)) | ((_m->CABIN_FAN_SPEED & (0x01U)) << 1) | ((_m->CABIN_TEMP & (0x01U)) << 2);
  cframe->Data[4] |= (_m->COUNTER & (0x0FU)) | ((_m->COMPLEMENT & (0x0FU)) << 4);
  cframe->Data[5] |= (_m->CONFIG_FAULT & (0x01U)) | ((_m->CAN_TIMEOUT_FAULT & (0x01U)) << 1) | ((_m->INTERNAL_SUPPLY_VOLTAGE_FAULT & (0x01U)) << 2) | ((_m->SUPERVISORY_TIMEOUT & (0x01U)) << 3) | ((_m->SUPERVISORY_SANITY_FAULT & (0x01U)) << 4) | ((_m->WATCHDOG_SANITY_FAULT & (0x01U)) << 5);
...
uint32_t Pack_COMPONENT_RPT_00_pacmod9(COMPONENT_RPT_00_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  ...
  _d[2] |= (_m->STEERING & (0x01U)) | ((_m->TURN & (0x01U)) << 1) | ((_m->WIPER & (0x01U)) << 2) | ((_m->WATCHDOG & (0x01U)) << 3) | ((_m->BRAKE_DECCEL & (0x01U)) << 4) | ((_m->REAR_PASS_DOOR & (0x01U)) << 5) | ((_m->ENGINE_BRAKE & (0x01U)) << 6) | ((_m->MARKER_LAMP & (0x01U)) << 7);
  _d[3] |= (_m->CABIN_CLIMATE & (0x01U)) | ((_m->CABIN_FAN_SPEED & (0x01U)) << 1) | ((_m->CABIN_TEMP & (0x01U)) << 2);
  _d[4] |= (_m->COUNTER & (0x0FU)) | ((_m->COMPLEMENT & (0x0FU)) << 4);
  _d[5] |= (_m->CONFIG_FAULT & (0x01U)) | ((_m->CAN_TIMEOUT_FAULT & (0x01U)) << 1) | ((_m->INTERNAL_SUPPLY_VOLTAGE_FAULT & (0x01U)) << 2) | ((_m->SUPERVISORY_TIMEOUT & (0x01U)) << 3) | ((_m->SUPERVISORY_SANITY_FAULT & (0x01U)) << 4) | ((_m->WATCHDOG_SANITY_FAULT & (0x01U)) << 5);
...
uint32_t Unpack_COMPONENT_RPT_01_pacmod9(COMPONENT_RPT_01_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->COMPONENT_TYPE = (_d[0] & (0x0FU));
  _m->ACCEL = ((_d[0] >> 4) & (0x01U));
  ...
  FMon_COMPONENT_RPT_01_pacmod9(&_m->mon1, COMPONENT_RPT_01_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_COMPONENT_RPT_01_pacmod9(COMPONENT_RPT_01_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_COMPONENT_RPT_01_pacmod9(COMPONENT_RPT_01_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_COMPONENT_RPT_02_pacmod9(COMPONENT_RPT_02_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->COMPONENT_TYPE = (_d[0] & (0x0FU));
  _m->ACCEL = ((_d[0] >> 4) & (0x01U));
  ...
  FMon_COMPONENT_RPT_02_pacmod9(&_m->mon1, COMPONENT_RPT_02_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_COMPONENT_RPT_02_pacmod9(COMPONENT_RPT_02_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_COMPONENT_RPT_02_pacmod9(COMPONENT_RPT_02_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_COMPONENT_RPT_03_pacmod9(COMPONENT_RPT_03_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->COMPONENT_TYPE = (_d[0] & (0x0FU));
  _m->ACCEL = ((_d[0] >> 4) & (0x01U));
  ...
  FMon_COMPONENT_RPT_03_pacmod9(&_m->mon1, COMPONENT_RPT_03_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_COMPONENT_RPT_03_pacmod9(COMPONENT_RPT_03_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_COMPONENT_RPT_03_pacmod9(COMPONENT_RPT_03_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SAFETY_FUNC_RPT_pacmod9(SAFETY_FUNC_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->COMMANDED_VALUE = (_d[0] & (0x0FU));
  _m->STATE = ((_d[0] >> 4) & (0x0FU));
  _m->AUTOMANUAL_OPCTRL = (_d[1] & (0x03U));
  ...
  _m->AUTO_READY_STATE_OBTAINABLE = ((_d[3] >> 1) & (0x01U));
  _m->AUTO_STATE_OBTAINABLE = ((_d[3] >> 2) & (0x01U));
  ...
  FMon_SAFETY_FUNC_RPT_pacmod9(&_m->mon1, SAFETY_FUNC_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SAFETY_FUNC_RPT_pacmod9(SAFETY_FUNC_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < SAFETY_FUNC_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

  cframe->Data[0] |= (_m->COMMANDED_VALUE & (0x0FU)) | ((_m->STATE & (0x0FU)) << 4);
  cframe->Data[1] |= (_m->AUTOMANUAL_OPCTRL & (0x03U)) | ((_m->CABIN_SAFETY_BRAKE_OPCTRL & (0x03U)) << 2) | ((_m->REMOTE_STOP_STATUS & (0x03U)) << 4) | ((_m->ENGINE_STATUS & (0x01U)) << 6) | ((_m->PACMOD_SYSTEM_STATUS & (0x01U)) << 7);
  cframe->Data[2] |= (_m->USER_PC_FAULT & (0x03U)) | ((_m->PACMOD_SYSTEM_FAULT & (0x03U)) << 2);
  cframe->Data[3] |= (_m->MANUAL_STATE_OBTAINABLE & (0x01U)) | ((_m->AUTO_READY_STATE_OBTAINABLE & (0x01U)) << 1) | ((_m->AUTO_STATE_OBTAINABLE & (0x01U)) << 2) | ((_m->MANUAL_READY_STATE_OBTAINABLE & (0x01U)) << 3) | ((_m->CRITICAL_STOP1_STATE_OBTAINABLE & (0x01U)) << 4) | ((_m->CRITICAL_STOP2_STATE_OBTAINABLE & (0x01U)) << 5);
...
uint32_t Pack_SAFETY_FUNC_RPT_pacmod9(SAFETY_FUNC_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < SAFETY_FUNC_RPT_DLC) && (i < 8); _d[i++] = 0);

  _d[0] |= (_m->COMMANDED_VALUE & (0x0FU)) | ((_m->STATE & (0x0FU)) << 4);
  _d[1] |= (_m->AUTOMANUAL_OPCTRL & (0x03U)) | ((_m->CABIN_SAFETY_BRAKE_OPCTRL & (0x03U)) << 2) | ((_m->REMOTE_STOP_STATUS & (0x03U)) << 4) | ((_m->ENGINE_STATUS & (0x01U)) << 6) | ((_m->PACMOD_SYSTEM_STATUS & (0x01U)) << 7);
  _d[2] |= (_m->USER_PC_FAULT & (0x03U)) | ((_m->PACMOD_SYSTEM_FAULT & (0x03U)) << 2);
  _d[3] |= (_m->MANUAL_STATE_OBTAINABLE & (0x01U)) | ((_m->AUTO_READY_STATE_OBTAINABLE & (0x01U)) << 1) | ((_m->AUTO_STATE_OBTAINABLE & (0x01U)) << 2) | ((_m->MANUAL_READY_STATE_OBTAINABLE & (0x01U)) << 3) | ((_m->CRITICAL_STOP1_STATE_OBTAINABLE & (0x01U)) << 4) | ((_m->CRITICAL_STOP2_STATE_OBTAINABLE & (0x01U)) << 5);
...
uint32_t Unpack_SAFETY_BRAKE_RPT_pacmod9(SAFETY_BRAKE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->COMMANDED_VALUE = (_d[0] & (0x01U));
  _m->OUTPUT_VALUE = ((_d[0] >> 1) & (0x01U));
  _m->REPORTED_FAULT = ((_d[0] >> 2) & (0x01U));
  ...
  FMon_SAFETY_BRAKE_RPT_pacmod9(&_m->mon1, SAFETY_BRAKE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SAFETY_BRAKE_RPT_pacmod9(SAFETY_BRAKE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < SAFETY_BRAKE_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

  cframe->Data[0] |= (_m->COMMANDED_VALUE & (0x01U)) | ((_m->OUTPUT_VALUE & (0x01U)) << 1) | ((_m->REPORTED_FAULT & (0x01U)) << 2) | ((_m->COMMAND_REPORTED_FAULT & (0x01U)) << 3) | ((_m->COMMAND_TIMEOUT & (0x01U)) << 4) | ((_m->COMMAND_PERMITTED & (0x01U)) << 5);
...
uint32_t Pack_SAFETY_BRAKE_RPT_pacmod9(SAFETY_BRAKE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < SAFETY_BRAKE_RPT_DLC) && (i < 8); _d[i++] = 0);

  _d[0] |= (_m->COMMANDED_VALUE & (0x01U)) | ((_m->OUTPUT_VALUE & (0x01U)) << 1) | ((_m->REPORTED_FAULT & (0x01U)) << 2) | ((_m->COMMAND_REPORTED_FAULT & (0x01U)) << 3) | ((_m->COMMAND_TIMEOUT & (0x01U)) << 4) | ((_m->COMMAND_PERMITTED & (0x01U)) << 5);
...
uint32_t Unpack_GLOBAL_CMD_pacmod9(GLOBAL_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_GLOBAL_CMD_pacmod9(&_m->mon1, GLOBAL_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_GLOBAL_CMD_pacmod9(GLOBAL_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_GLOBAL_CMD_pacmod9(GLOBAL_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SUPERVISORY_CTRL_pacmod9(SUPERVISORY_CTRL_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_SUPERVISORY_CTRL_pacmod9(&_m->mon1, SUPERVISORY_CTRL_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SUPERVISORY_CTRL_pacmod9(SUPERVISORY_CTRL_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SUPERVISORY_CTRL_pacmod9(SUPERVISORY_CTRL_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SAFETY_FUNC_CMD_pacmod9(SAFETY_FUNC_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_SAFETY_FUNC_CMD_pacmod9(&_m->mon1, SAFETY_FUNC_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SAFETY_FUNC_CMD_pacmod9(SAFETY_FUNC_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SAFETY_FUNC_CMD_pacmod9(SAFETY_FUNC_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SAFETY_BRAKE_CMD_pacmod9(SAFETY_BRAKE_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_SAFETY_BRAKE_CMD_pacmod9(&_m->mon1, SAFETY_BRAKE_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SAFETY_BRAKE_CMD_pacmod9(SAFETY_BRAKE_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SAFETY_BRAKE_CMD_pacmod9(SAFETY_BRAKE_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ACCEL_CMD_pacmod9(ACCEL_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ACCEL_CMD_phys = (sigfloat_t)(PACMOD9_ACCEL_CMD_ro_fromS(_m->ACCEL_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_ACCEL_CMD_pacmod9(&_m->mon1, ACCEL_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ACCEL_CMD_pacmod9(ACCEL_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < ACCEL_CMD_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->ACCEL_CMD_ro = PACMOD9_ACCEL_CMD_ro_toS(_m->ACCEL_CMD_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_ACCEL_CMD_pacmod9(ACCEL_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_CMD_pacmod9(BRAKE_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_CMD_phys = (sigfloat_t)(PACMOD9_BRAKE_CMD_ro_fromS(_m->BRAKE_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_CMD_pacmod9(&_m->mon1, BRAKE_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_CMD_pacmod9(BRAKE_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_CMD_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_CMD_ro = PACMOD9_BRAKE_CMD_ro_toS(_m->BRAKE_CMD_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_BRAKE_CMD_pacmod9(BRAKE_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CRUISE_CONTROL_BUTTONS_CMD_pacmod9(CRUISE_CONTROL_BUTTONS_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CRUISE_CONTROL_BUTTONS_CMD_pacmod9(&_m->mon1, CRUISE_CONTROL_BUTTONS_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CRUISE_CONTROL_BUTTONS_CMD_pacmod9(CRUISE_CONTROL_BUTTONS_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CRUISE_CONTROL_BUTTONS_CMD_pacmod9(CRUISE_CONTROL_BUTTONS_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DASH_CONTROLS_LEFT_CMD_pacmod9(DASH_CONTROLS_LEFT_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_DASH_CONTROLS_LEFT_CMD_pacmod9(&_m->mon1, DASH_CONTROLS_LEFT_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DASH_CONTROLS_LEFT_CMD_pacmod9(DASH_CONTROLS_LEFT_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_DASH_CONTROLS_LEFT_CMD_pacmod9(DASH_CONTROLS_LEFT_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DASH_CONTROLS_RIGHT_CMD_pacmod9(DASH_CONTROLS_RIGHT_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_DASH_CONTROLS_RIGHT_CMD_pacmod9(&_m->mon1, DASH_CONTROLS_RIGHT_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DASH_CONTROLS_RIGHT_CMD_pacmod9(DASH_CONTROLS_RIGHT_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_DASH_CONTROLS_RIGHT_CMD_pacmod9(DASH_CONTROLS_RIGHT_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_HAZARD_LIGHTS_CMD_pacmod9(HAZARD_LIGHTS_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_HAZARD_LIGHTS_CMD_pacmod9(&_m->mon1, HAZARD_LIGHTS_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HAZARD_LIGHTS_CMD_pacmod9(HAZARD_LIGHTS_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HAZARD_LIGHTS_CMD_pacmod9(HAZARD_LIGHTS_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_HEADLIGHT_CMD_pacmod9(HEADLIGHT_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_HEADLIGHT_CMD_pacmod9(&_m->mon1, HEADLIGHT_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HEADLIGHT_CMD_pacmod9(HEADLIGHT_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HEADLIGHT_CMD_pacmod9(HEADLIGHT_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_HORN_CMD_pacmod9(HORN_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_HORN_CMD_pacmod9(&_m->mon1, HORN_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HORN_CMD_pacmod9(HORN_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HORN_CMD_pacmod9(HORN_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_MEDIA_CONTROLS_CMD_pacmod9(MEDIA_CONTROLS_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_MEDIA_CONTROLS_CMD_pacmod9(&_m->mon1, MEDIA_CONTROLS_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_MEDIA_CONTROLS_CMD_pacmod9(MEDIA_CONTROLS_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_MEDIA_CONTROLS_CMD_pacmod9(MEDIA_CONTROLS_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_PARKING_BRAKE_CMD_pacmod9(PARKING_BRAKE_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_PARKING_BRAKE_CMD_pacmod9(&_m->mon1, PARKING_BRAKE_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_PARKING_BRAKE_CMD_pacmod9(PARKING_BRAKE_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_PARKING_BRAKE_CMD_pacmod9(PARKING_BRAKE_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SHIFT_CMD_pacmod9(SHIFT_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_SHIFT_CMD_pacmod9(&_m->mon1, SHIFT_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SHIFT_CMD_pacmod9(SHIFT_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SHIFT_CMD_pacmod9(SHIFT_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_STEERING_CMD_pacmod9(STEERING_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->POSITION_phys = (sigfloat_t)(PACMOD9_POSITION_ro_fromS(_m->POSITION_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->ROTATION_RATE_ro = ((_d[3] & (0xFFU)) << 8) | (_d[4] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ROTATION_RATE_phys = (sigfloat_t)(PACMOD9_ROTATION_RATE_ro_fromS(_m->ROTATION_RATE_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_STEERING_CMD_pacmod9(&_m->mon1, STEERING_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_CMD_pacmod9(STEERING_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < STEERING_CMD_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->POSITION_ro = PACMOD9_POSITION_ro_toS(_m->POSITION_phys);
  _m->ROTATION_RATE_ro = PACMOD9_ROTATION_RATE_ro_toS(_m->ROTATION_RATE_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_STEERING_CMD_pacmod9(STEERING_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_TURN_CMD_pacmod9(TURN_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_TURN_CMD_pacmod9(&_m->mon1, TURN_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_TURN_CMD_pacmod9(TURN_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_TURN_CMD_pacmod9(TURN_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_WIPER_CMD_pacmod9(WIPER_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_WIPER_CMD_pacmod9(&_m->mon1, WIPER_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_WIPER_CMD_pacmod9(WIPER_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_WIPER_CMD_pacmod9(WIPER_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SPRAYER_CMD_pacmod9(SPRAYER_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_SPRAYER_CMD_pacmod9(&_m->mon1, SPRAYER_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SPRAYER_CMD_pacmod9(SPRAYER_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SPRAYER_CMD_pacmod9(SPRAYER_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_DECCEL_CMD_pacmod9(BRAKE_DECCEL_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_DECCEL_CMD_phys = (sigfloat_t)(PACMOD9_BRAKE_DECCEL_CMD_ro_fromS(_m->BRAKE_DECCEL_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_DECCEL_CMD_pacmod9(&_m->mon1, BRAKE_DECCEL_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_DECCEL_CMD_pacmod9(BRAKE_DECCEL_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_DECCEL_CMD_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_DECCEL_CMD_ro = PACMOD9_BRAKE_DECCEL_CMD_ro_toS(_m->BRAKE_DECCEL_CMD_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_BRAKE_DECCEL_CMD_pacmod9(BRAKE_DECCEL_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_REAR_PASS_DOOR_CMD_pacmod9(REAR_PASS_DOOR_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_REAR_PASS_DOOR_CMD_pacmod9(&_m->mon1, REAR_PASS_DOOR_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_REAR_PASS_DOOR_CMD_pacmod9(REAR_PASS_DOOR_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_REAR_PASS_DOOR_CMD_pacmod9(REAR_PASS_DOOR_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ENGINE_BRAKE_CMD_pacmod9(ENGINE_BRAKE_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_ENGINE_BRAKE_CMD_pacmod9(&_m->mon1, ENGINE_BRAKE_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ENGINE_BRAKE_CMD_pacmod9(ENGINE_BRAKE_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_ENGINE_BRAKE_CMD_pacmod9(ENGINE_BRAKE_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_MARKER_LAMP_CMD_pacmod9(MARKER_LAMP_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_MARKER_LAMP_CMD_pacmod9(&_m->mon1, MARKER_LAMP_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_MARKER_LAMP_CMD_pacmod9(MARKER_LAMP_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_MARKER_LAMP_CMD_pacmod9(MARKER_LAMP_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CABIN_TEMP_CMD_pacmod9(CABIN_TEMP_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->CABIN_TEMP_CMD_phys = (sigfloat_t)(PACMOD9_CABIN_TEMP_CMD_ro_fromS(_m->CABIN_TEMP_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_CABIN_TEMP_CMD_pacmod9(&_m->mon1, CABIN_TEMP_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CABIN_TEMP_CMD_pacmod9(CABIN_TEMP_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < CABIN_TEMP_CMD_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->CABIN_TEMP_CMD_ro = PACMOD9_CABIN_TEMP_CMD_ro_toS(_m->CABIN_TEMP_CMD_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_CABIN_TEMP_CMD_pacmod9(CABIN_TEMP_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CABIN_FAN_SPEED_CMD_pacmod9(CABIN_FAN_SPEED_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CABIN_FAN_SPEED_CMD_pacmod9(&_m->mon1, CABIN_FAN_SPEED_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CABIN_FAN_SPEED_CMD_pacmod9(CABIN_FAN_SPEED_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CABIN_FAN_SPEED_CMD_pacmod9(CABIN_FAN_SPEED_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CABIN_CLIMATE_CMD_pacmod9(CABIN_CLIMATE_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLE = (_d[0] & (0x01U));
  _m->IGNORE_OVERRIDES = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CABIN_CLIMATE_CMD_pacmod9(&_m->mon1, CABIN_CLIMATE_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CABIN_CLIMATE_CMD_pacmod9(CABIN_CLIMATE_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CABIN_CLIMATE_CMD_pacmod9(CABIN_CLIMATE_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ACCEL_RPT_pacmod9(ACCEL_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->MANUAL_INPUT_phys = (sigfloat_t)(PACMOD9_MANUAL_INPUT_ro_fromS(_m->MANUAL_INPUT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->COMMANDED_VALUE_ro = ((_d[3] & (0xFFU)) << 8) | (_d[4] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->COMMANDED_VALUE_phys = (sigfloat_t)(PACMOD9_COMMANDED_VALUE_ro_fromS(_m->COMMANDED_VALUE_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->OUTPUT_VALUE_ro = ((_d[5] & (0xFFU)) << 8) | (_d[6] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->OUTPUT_VALUE_phys = (sigfloat_t)(PACMOD9_OUTPUT_VALUE_ro_fromS(_m->OUTPUT_VALUE_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_ACCEL_RPT_pacmod9(&_m->mon1, ACCEL_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ACCEL_RPT_pacmod9(ACCEL_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < ACCEL_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->MANUAL_INPUT_ro = PACMOD9_MANUAL_INPUT_ro_toS(_m->MANUAL_INPUT_phys);
  _m->COMMANDED_VALUE_ro = PACMOD9_COMMANDED_VALUE_ro_toS(_m->COMMANDED_VALUE_phys);
  _m->OUTPUT_VALUE_ro = PACMOD9_OUTPUT_VALUE_ro_toS(_m->OUTPUT_VALUE_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_ACCEL_RPT_pacmod9(ACCEL_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ACCEL_CMD_LIMIT_RPT_pacmod9(ACCEL_CMD_LIMIT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ACCEL_CMD_LIMIT_ro = ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ACCEL_CMD_LIMIT_phys = (sigfloat_t)(PACMOD9_ACCEL_CMD_LIMIT_ro_fromS(_m->ACCEL_CMD_LIMIT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->LIMITED_ACCEL_CMD_ro = ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->LIMITED_ACCEL_CMD_phys = (sigfloat_t)(PACMOD9_LIMITED_ACCEL_CMD_ro_fromS(_m->LIMITED_ACCEL_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_ACCEL_CMD_LIMIT_RPT_pacmod9(&_m->mon1, ACCEL_CMD_LIMIT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ACCEL_CMD_LIMIT_RPT_pacmod9(ACCEL_CMD_LIMIT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < ACCEL_CMD_LIMIT_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->ACCEL_CMD_LIMIT_ro = PACMOD9_ACCEL_CMD_LIMIT_ro_toS(_m->ACCEL_CMD_LIMIT_phys);
  _m->LIMITED_ACCEL_CMD_ro = PACMOD9_LIMITED_ACCEL_CMD_ro_toS(_m->LIMITED_ACCEL_CMD_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_ACCEL_CMD_LIMIT_RPT_pacmod9(ACCEL_CMD_LIMIT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_RPT_pacmod9(BRAKE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_BRAKE_RPT_pacmod9(&_m->mon1, BRAKE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_RPT_pacmod9(BRAKE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_BRAKE_RPT_pacmod9(BRAKE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_CMD_LIMIT_RPT_pacmod9(BRAKE_CMD_LIMIT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->BRAKE_CMD_LIMIT_ro = ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_CMD_LIMIT_phys = (sigfloat_t)(PACMOD9_BRAKE_CMD_LIMIT_ro_fromS(_m->BRAKE_CMD_LIMIT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->LIMITED_BRAKE_CMD_ro = ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->LIMITED_BRAKE_CMD_phys = (sigfloat_t)(PACMOD9_LIMITED_BRAKE_CMD_ro_fromS(_m->LIMITED_BRAKE_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_CMD_LIMIT_RPT_pacmod9(&_m->mon1, BRAKE_CMD_LIMIT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_CMD_LIMIT_RPT_pacmod9(BRAKE_CMD_LIMIT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_CMD_LIMIT_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_CMD_LIMIT_ro = PACMOD9_BRAKE_CMD_LIMIT_ro_toS(_m->BRAKE_CMD_LIMIT_phys);
  _m->LIMITED_BRAKE_CMD_ro = PACMOD9_LIMITED_BRAKE_CMD_ro_toS(_m->LIMITED_BRAKE_CMD_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_BRAKE_CMD_LIMIT_RPT_pacmod9(BRAKE_CMD_LIMIT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CRUISE_CONTROL_BUTTONS_RPT_pacmod9(CRUISE_CONTROL_BUTTONS_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CRUISE_CONTROL_BUTTONS_RPT_pacmod9(&_m->mon1, CRUISE_CONTROL_BUTTONS_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CRUISE_CONTROL_BUTTONS_RPT_pacmod9(CRUISE_CONTROL_BUTTONS_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CRUISE_CONTROL_BUTTONS_RPT_pacmod9(CRUISE_CONTROL_BUTTONS_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DASH_CONTROLS_LEFT_RPT_pacmod9(DASH_CONTROLS_LEFT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_DASH_CONTROLS_LEFT_RPT_pacmod9(&_m->mon1, DASH_CONTROLS_LEFT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DASH_CONTROLS_LEFT_RPT_pacmod9(DASH_CONTROLS_LEFT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_DASH_CONTROLS_LEFT_RPT_pacmod9(DASH_CONTROLS_LEFT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DASH_CONTROLS_RIGHT_RPT_pacmod9(DASH_CONTROLS_RIGHT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_DASH_CONTROLS_RIGHT_RPT_pacmod9(&_m->mon1, DASH_CONTROLS_RIGHT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DASH_CONTROLS_RIGHT_RPT_pacmod9(DASH_CONTROLS_RIGHT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_DASH_CONTROLS_RIGHT_RPT_pacmod9(DASH_CONTROLS_RIGHT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_HAZARD_LIGHTS_RPT_pacmod9(HAZARD_LIGHTS_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_HAZARD_LIGHTS_RPT_pacmod9(&_m->mon1, HAZARD_LIGHTS_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HAZARD_LIGHTS_RPT_pacmod9(HAZARD_LIGHTS_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HAZARD_LIGHTS_RPT_pacmod9(HAZARD_LIGHTS_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_HEADLIGHT_RPT_pacmod9(HEADLIGHT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_HEADLIGHT_RPT_pacmod9(&_m->mon1, HEADLIGHT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HEADLIGHT_RPT_pacmod9(HEADLIGHT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HEADLIGHT_RPT_pacmod9(HEADLIGHT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_HORN_RPT_pacmod9(HORN_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_HORN_RPT_pacmod9(&_m->mon1, HORN_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HORN_RPT_pacmod9(HORN_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HORN_RPT_pacmod9(HORN_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_MEDIA_CONTROLS_RPT_pacmod9(MEDIA_CONTROLS_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_MEDIA_CONTROLS_RPT_pacmod9(&_m->mon1, MEDIA_CONTROLS_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_MEDIA_CONTROLS_RPT_pacmod9(MEDIA_CONTROLS_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_MEDIA_CONTROLS_RPT_pacmod9(MEDIA_CONTROLS_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_PARKING_BRAKE_RPT_pacmod9(PARKING_BRAKE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_PARKING_BRAKE_RPT_pacmod9(&_m->mon1, PARKING_BRAKE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_PARKING_BRAKE_RPT_pacmod9(PARKING_BRAKE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_PARKING_BRAKE_RPT_pacmod9(PARKING_BRAKE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SHIFT_RPT_pacmod9(SHIFT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_SHIFT_RPT_pacmod9(&_m->mon1, SHIFT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SHIFT_RPT_pacmod9(SHIFT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SHIFT_RPT_pacmod9(SHIFT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_STEERING_RPT_pacmod9(STEERING_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_STEERING_RPT_pacmod9(&_m->mon1, STEERING_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_RPT_pacmod9(STEERING_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_STEERING_RPT_pacmod9(STEERING_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_STEERING_CMD_LIMIT_RPT_pacmod9(STEERING_CMD_LIMIT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->POSITION_CMD_LIMIT_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->POSITION_CMD_LIMIT_phys = (sigfloat_t)(PACMOD9_POSITION_CMD_LIMIT_ro_fromS(_m->POSITION_CMD_LIMIT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->LIMITED_POSITION_CMD_ro = __ext_sig__(( ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->LIMITED_POSITION_CMD_phys = (sigfloat_t)(PACMOD9_LIMITED_POSITION_CMD_ro_fromS(_m->LIMITED_POSITION_CMD_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->ROTATION_RATE_CMD_LIMIT_ro = ((_d[4] & (0xFFU)) << 8) | (_d[5] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ROTATION_RATE_CMD_LIMIT_phys = (sigfloat_t)(PACMOD9_ROTATION_RATE_CMD_LIMIT_ro_fromS(_m->ROTATION_RATE_CMD_LIMIT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->LIMITED_ROTATION_RATE_ro = ((_d[6] & (0xFFU)) << 8) | (_d[7] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->LIMITED_ROTATION_RATE_phys = (sigfloat_t)(PACMOD9_LIMITED_ROTATION_RATE_ro_fromS(_m->LIMITED_ROTATION_RATE_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_STEERING_CMD_LIMIT_RPT_pacmod9(&_m->mon1, STEERING_CMD_LIMIT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_CMD_LIMIT_RPT_pacmod9(STEERING_CMD_LIMIT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < STEERING_CMD_LIMIT_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->POSITION_CMD_LIMIT_ro = PACMOD9_POSITION_CMD_LIMIT_ro_toS(_m->POSITION_CMD_LIMIT_phys);
  _m->LIMITED_POSITION_CMD_ro = PACMOD9_LIMITED_POSITION_CMD_ro_toS(_m->LIMITED_POSITION_CMD_phys);
  _m->ROTATION_RATE_CMD_LIMIT_ro = PACMOD9_ROTATION_RATE_CMD_LIMIT_ro_toS(_m->ROTATION_RATE_CMD_LIMIT_phys);
  _m->LIMITED_ROTATION_RATE_ro = PACMOD9_LIMITED_ROTATION_RATE_ro_toS(_m->LIMITED_ROTATION_RATE_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_STEERING_CMD_LIMIT_RPT_pacmod9(STEERING_CMD_LIMIT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_TURN_RPT_pacmod9(TURN_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_TURN_RPT_pacmod9(&_m->mon1, TURN_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_TURN_RPT_pacmod9(TURN_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_TURN_RPT_pacmod9(TURN_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_WIPER_RPT_pacmod9(WIPER_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_WIPER_RPT_pacmod9(&_m->mon1, WIPER_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_WIPER_RPT_pacmod9(WIPER_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_WIPER_RPT_pacmod9(WIPER_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SPRAYER_RPT_pacmod9(SPRAYER_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_SPRAYER_RPT_pacmod9(&_m->mon1, SPRAYER_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SPRAYER_RPT_pacmod9(SPRAYER_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SPRAYER_RPT_pacmod9(SPRAYER_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_DECCEL_RPT_pacmod9(BRAKE_DECCEL_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_BRAKE_DECCEL_RPT_pacmod9(&_m->mon1, BRAKE_DECCEL_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_DECCEL_RPT_pacmod9(BRAKE_DECCEL_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_BRAKE_DECCEL_RPT_pacmod9(BRAKE_DECCEL_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_REAR_PASS_DOOR_RPT_pacmod9(REAR_PASS_DOOR_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_REAR_PASS_DOOR_RPT_pacmod9(&_m->mon1, REAR_PASS_DOOR_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_REAR_PASS_DOOR_RPT_pacmod9(REAR_PASS_DOOR_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_REAR_PASS_DOOR_RPT_pacmod9(REAR_PASS_DOOR_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ENGINE_BRAKE_RPT_pacmod9(ENGINE_BRAKE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_ENGINE_BRAKE_RPT_pacmod9(&_m->mon1, ENGINE_BRAKE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ENGINE_BRAKE_RPT_pacmod9(ENGINE_BRAKE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_ENGINE_BRAKE_RPT_pacmod9(ENGINE_BRAKE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_MARKER_LAMP_RPT_pacmod9(MARKER_LAMP_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_MARKER_LAMP_RPT_pacmod9(&_m->mon1, MARKER_LAMP_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_MARKER_LAMP_RPT_pacmod9(MARKER_LAMP_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_MARKER_LAMP_RPT_pacmod9(MARKER_LAMP_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CABIN_TEMP_RPT_pacmod9(CABIN_TEMP_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CABIN_TEMP_RPT_pacmod9(&_m->mon1, CABIN_TEMP_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CABIN_TEMP_RPT_pacmod9(CABIN_TEMP_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CABIN_TEMP_RPT_pacmod9(CABIN_TEMP_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CABIN_FAN_SPEED_RPT_pacmod9(CABIN_FAN_SPEED_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CABIN_FAN_SPEED_RPT_pacmod9(&_m->mon1, CABIN_FAN_SPEED_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CABIN_FAN_SPEED_RPT_pacmod9(CABIN_FAN_SPEED_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CABIN_FAN_SPEED_RPT_pacmod9(CABIN_FAN_SPEED_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_CABIN_CLIMATE_RPT_pacmod9(CABIN_CLIMATE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENABLED = (_d[0] & (0x01U));
  _m->OVERRIDE_ACTIVE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_CABIN_CLIMATE_RPT_pacmod9(&_m->mon1, CABIN_CLIMATE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_CABIN_CLIMATE_RPT_pacmod9(CABIN_CLIMATE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_CABIN_CLIMATE_RPT_pacmod9(CABIN_CLIMATE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ACCEL_AUX_RPT_pacmod9(ACCEL_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_ACCEL_AUX_RPT_pacmod9(&_m->mon1, ACCEL_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ACCEL_AUX_RPT_pacmod9(ACCEL_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < ACCEL_AUX_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

  cframe->Data[4] |= (_m->OPERATOR_INTERACTION & (0x01U));
  cframe->Data[5] |= ((_m->OPERATOR_INTERACTION_AVAIL & (0x01U)) << 2);
...
uint32_t Pack_ACCEL_AUX_RPT_pacmod9(ACCEL_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < ACCEL_AUX_RPT_DLC) && (i < 8); _d[i++] = 0);

  _d[4] |= (_m->OPERATOR_INTERACTION & (0x01U));
  _d[5] |= ((_m->OPERATOR_INTERACTION_AVAIL & (0x01U)) << 2);
...
uint32_t Unpack_BRAKE_AUX_RPT_pacmod9(BRAKE_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->BRAKE_PRESSURE_ro = ((_d[4] & (0xFFU)) << 8) | (_d[5] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_PRESSURE_phys = (sigfloat_t)(PACMOD9_BRAKE_PRESSURE_ro_fromS(_m->BRAKE_PRESSURE_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_AUX_RPT_pacmod9(&_m->mon1, BRAKE_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_AUX_RPT_pacmod9(BRAKE_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_AUX_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->BRAKE_PRESSURE_ro = PACMOD9_BRAKE_PRESSURE_ro_toS(_m->BRAKE_PRESSURE_phys);
#endif // PACMOD9_USE_SIGFLOAT
  ...
  cframe->Data[7] |= ((_m->BRAKE_PRESSURE_AVAIL & (0x01U)) << 2) | ((_m->OPERATOR_INTERACTION_AVAIL & (0x01U)) << 3) | ((_m->BRAKE_ON_OFF_AVAIL & (0x01U)) << 4);
...
uint32_t Pack_BRAKE_AUX_RPT_pacmod9(BRAKE_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  ...
  _d[7] |= ((_m->BRAKE_PRESSURE_AVAIL & (0x01U)) << 2) | ((_m->OPERATOR_INTERACTION_AVAIL & (0x01U)) << 3) | ((_m->BRAKE_ON_OFF_AVAIL & (0x01U)) << 4);
...
uint32_t Unpack_HEADLIGHT_AUX_RPT_pacmod9(HEADLIGHT_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_HEADLIGHT_AUX_RPT_pacmod9(&_m->mon1, HEADLIGHT_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_HEADLIGHT_AUX_RPT_pacmod9(HEADLIGHT_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_HEADLIGHT_AUX_RPT_pacmod9(HEADLIGHT_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_PARKING_BRAKE_AUX_RPT_pacmod9(PARKING_BRAKE_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_PARKING_BRAKE_AUX_RPT_pacmod9(&_m->mon1, PARKING_BRAKE_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_PARKING_BRAKE_AUX_RPT_pacmod9(PARKING_BRAKE_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_PARKING_BRAKE_AUX_RPT_pacmod9(PARKING_BRAKE_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SHIFT_AUX_RPT_pacmod9(SHIFT_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_SHIFT_AUX_RPT_pacmod9(&_m->mon1, SHIFT_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SHIFT_AUX_RPT_pacmod9(SHIFT_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < SHIFT_AUX_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

  cframe->Data[0] |= (_m->BETWEEN_GEARS & (0x01U)) | ((_m->STAY_IN_NEUTRAL_MODE & (0x01U)) << 1) | ((_m->BRAKE_INTERLOCK_ACTIVE & (0x01U)) << 2) | ((_m->SPEED_INTERLOCK_ACTIVE & (0x01U)) << 3) | ((_m->WRITE_TO_CONFIG & (0x01U)) << 4);
  cframe->Data[1] |= (_m->BETWEEN_GEARS_AVAIL & (0x01U)) | ((_m->STAY_IN_NEUTRAL_MODE_AVAIL & (0x01U)) << 1) | ((_m->BRAKE_INTERLOCK_ACTIVE_AVAIL & (0x01U)) << 2) | ((_m->SPEED_INTERLOCK_ACTIVE_AVAIL & (0x01U)) << 3) | ((_m->WRITE_TO_CONFIG_IS_VALID & (0x01U)) << 4) | ((_m->GEAR_NUMBER_AVAIL & (0x01U)) << 5);
  cframe->Data[2] |= (_m->GEAR_NUMBER & (0x3FU));
...
uint32_t Pack_SHIFT_AUX_RPT_pacmod9(SHIFT_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < SHIFT_AUX_RPT_DLC) && (i < 8); _d[i++] = 0);

  _d[0] |= (_m->BETWEEN_GEARS & (0x01U)) | ((_m->STAY_IN_NEUTRAL_MODE & (0x01U)) << 1) | ((_m->BRAKE_INTERLOCK_ACTIVE & (0x01U)) << 2) | ((_m->SPEED_INTERLOCK_ACTIVE & (0x01U)) << 3) | ((_m->WRITE_TO_CONFIG & (0x01U)) << 4);
  _d[1] |= (_m->BETWEEN_GEARS_AVAIL & (0x01U)) | ((_m->STAY_IN_NEUTRAL_MODE_AVAIL & (0x01U)) << 1) | ((_m->BRAKE_INTERLOCK_ACTIVE_AVAIL & (0x01U)) << 2) | ((_m->SPEED_INTERLOCK_ACTIVE_AVAIL & (0x01U)) << 3) | ((_m->WRITE_TO_CONFIG_IS_VALID & (0x01U)) << 4) | ((_m->GEAR_NUMBER_AVAIL & (0x01U)) << 5);
  _d[2] |= (_m->GEAR_NUMBER & (0x3FU));
...
uint32_t Unpack_STEERING_AUX_RPT_pacmod9(STEERING_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->STEERING_TORQUE_ro = __ext_sig__(( ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->STEERING_TORQUE_phys = (sigfloat_t)(PACMOD9_STEERING_TORQUE_ro_fromS(_m->STEERING_TORQUE_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_STEERING_AUX_RPT_pacmod9(&_m->mon1, STEERING_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_AUX_RPT_pacmod9(STEERING_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < STEERING_AUX_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->STEERING_TORQUE_ro = PACMOD9_STEERING_TORQUE_ro_toS(_m->STEERING_TORQUE_phys);
  _m->ROTATION_RATE_ro = PACMOD9_ROTATION_RATE_ro_toS(_m->ROTATION_RATE_phys);
#endif // PACMOD9_USE_SIGFLOAT
  ...
  cframe->Data[6] |= (_m->OPERATOR_INTERACTION & (0x01U)) | ((_m->ROTATION_RATE_SIGN & (0x01U)) << 1) | ((_m->VEHICLE_ANGLE_CALIB_STATUS & (0x01U)) << 2);
  cframe->Data[7] |= ((_m->STEERING_TORQUE_AVAIL & (0x01U)) << 1) | ((_m->ROTATION_RATE_AVAIL & (0x01U)) << 2) | ((_m->OPERATOR_INTERACTION_AVAIL & (0x01U)) << 3) | ((_m->ROTATION_RATE_SIGN_AVAIL & (0x01U)) << 4) | ((_m->VEHICLE_ANGLE_CALIB_STATUS_AVAIL & (0x01U)) << 5);
...
uint32_t Pack_STEERING_AUX_RPT_pacmod9(STEERING_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  ...
  _d[6] |= (_m->OPERATOR_INTERACTION & (0x01U)) | ((_m->ROTATION_RATE_SIGN & (0x01U)) << 1) | ((_m->VEHICLE_ANGLE_CALIB_STATUS & (0x01U)) << 2);
  _d[7] |= ((_m->STEERING_TORQUE_AVAIL & (0x01U)) << 1) | ((_m->ROTATION_RATE_AVAIL & (0x01U)) << 2) | ((_m->OPERATOR_INTERACTION_AVAIL & (0x01U)) << 3) | ((_m->ROTATION_RATE_SIGN_AVAIL & (0x01U)) << 4) | ((_m->VEHICLE_ANGLE_CALIB_STATUS_AVAIL & (0x01U)) << 5);
...
uint32_t Unpack_TURN_AUX_RPT_pacmod9(TURN_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_TURN_AUX_RPT_pacmod9(&_m->mon1, TURN_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_TURN_AUX_RPT_pacmod9(TURN_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_TURN_AUX_RPT_pacmod9(TURN_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_WIPER_AUX_RPT_pacmod9(WIPER_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_WIPER_AUX_RPT_pacmod9(&_m->mon1, WIPER_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_WIPER_AUX_RPT_pacmod9(WIPER_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_WIPER_AUX_RPT_pacmod9(WIPER_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_DECCEL_AUX_RPT_pacmod9(BRAKE_DECCEL_AUX_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_BRAKE_DECCEL_AUX_RPT_pacmod9(&_m->mon1, BRAKE_DECCEL_AUX_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_DECCEL_AUX_RPT_pacmod9(BRAKE_DECCEL_AUX_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_BRAKE_DECCEL_AUX_RPT_pacmod9(BRAKE_DECCEL_AUX_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_VEHICLE_SPEED_RPT_pacmod9(VEHICLE_SPEED_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->VEHICLE_SPEED_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->VEHICLE_SPEED_phys = (sigfloat_t)(PACMOD9_VEHICLE_SPEED_ro_fromS(_m->VEHICLE_SPEED_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_VEHICLE_SPEED_RPT_pacmod9(&_m->mon1, VEHICLE_SPEED_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_VEHICLE_SPEED_RPT_pacmod9(VEHICLE_SPEED_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < VEHICLE_SPEED_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->VEHICLE_SPEED_ro = PACMOD9_VEHICLE_SPEED_ro_toS(_m->VEHICLE_SPEED_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_VEHICLE_SPEED_RPT_pacmod9(VEHICLE_SPEED_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_MOTOR_RPT_1_pacmod9(BRAKE_MOTOR_RPT_1_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->MOTOR_CURRENT_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 24) | ((_d[1] & (0xFFU)) << 16) | ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 32);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->MOTOR_CURRENT_phys = (sigfloat_t)(PACMOD9_MOTOR_CURRENT_ro_fromS(_m->MOTOR_CURRENT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->SHAFT_POSITION_ro = __ext_sig__(( ((_d[4] & (0xFFU)) << 24) | ((_d[5] & (0xFFU)) << 16) | ((_d[6] & (0xFFU)) << 8) | (_d[7] & (0xFFU)) ), 32);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->SHAFT_POSITION_phys = (sigfloat_t)(PACMOD9_SHAFT_POSITION_ro_fromS(_m->SHAFT_POSITION_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_MOTOR_RPT_1_pacmod9(&_m->mon1, BRAKE_MOTOR_RPT_1_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_MOTOR_RPT_1_pacmod9(BRAKE_MOTOR_RPT_1_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_MOTOR_RPT_1_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->MOTOR_CURRENT_ro = PACMOD9_MOTOR_CURRENT_ro_toS(_m->MOTOR_CURRENT_phys);
  _m->SHAFT_POSITION_ro = PACMOD9_SHAFT_POSITION_ro_toS(_m->SHAFT_POSITION_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_BRAKE_MOTOR_RPT_1_pacmod9(BRAKE_MOTOR_RPT_1_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_MOTOR_RPT_2_pacmod9(BRAKE_MOTOR_RPT_2_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ANGULAR_SPEED_phys = (sigfloat_t)(PACMOD9_ANGULAR_SPEED_ro_fromS(_m->ANGULAR_SPEED_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_MOTOR_RPT_2_pacmod9(&_m->mon1, BRAKE_MOTOR_RPT_2_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_MOTOR_RPT_2_pacmod9(BRAKE_MOTOR_RPT_2_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_MOTOR_RPT_2_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->ANGULAR_SPEED_ro = PACMOD9_ANGULAR_SPEED_ro_toS(_m->ANGULAR_SPEED_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_BRAKE_MOTOR_RPT_2_pacmod9(BRAKE_MOTOR_RPT_2_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_BRAKE_MOTOR_RPT_3_pacmod9(BRAKE_MOTOR_RPT_3_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->TORQUE_OUTPUT_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 24) | ((_d[1] & (0xFFU)) << 16) | ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 32);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->TORQUE_OUTPUT_phys = (sigfloat_t)(PACMOD9_TORQUE_OUTPUT_ro_fromS(_m->TORQUE_OUTPUT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->TORQUE_INPUT_ro = __ext_sig__(( ((_d[4] & (0xFFU)) << 24) | ((_d[5] & (0xFFU)) << 16) | ((_d[6] & (0xFFU)) << 8) | (_d[7] & (0xFFU)) ), 32);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->TORQUE_INPUT_phys = (sigfloat_t)(PACMOD9_TORQUE_INPUT_ro_fromS(_m->TORQUE_INPUT_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_BRAKE_MOTOR_RPT_3_pacmod9(&_m->mon1, BRAKE_MOTOR_RPT_3_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_BRAKE_MOTOR_RPT_3_pacmod9(BRAKE_MOTOR_RPT_3_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < BRAKE_MOTOR_RPT_3_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->TORQUE_OUTPUT_ro = PACMOD9_TORQUE_OUTPUT_ro_toS(_m->TORQUE_OUTPUT_phys);
  _m->TORQUE_INPUT_ro = PACMOD9_TORQUE_INPUT_ro_toS(_m->TORQUE_INPUT_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_BRAKE_MOTOR_RPT_3_pacmod9(BRAKE_MOTOR_RPT_3_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_STEERING_MOTOR_RPT_1_pacmod9(STEERING_MOTOR_RPT_1_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->MOTOR_CURRENT_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 24) | ((_d[1] & (0xFFU)) << 16) | ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 32);
#ifdef PACMOD9_USE_SIGFLOAT
  ...
  FMon_STEERING_MOTOR_RPT_1_pacmod9(&_m->mon1, STEERING_MOTOR_RPT_1_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_MOTOR_RPT_1_pacmod9(STEERING_MOTOR_RPT_1_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_STEERING_MOTOR_RPT_1_pacmod9(STEERING_MOTOR_RPT_1_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_STEERING_MOTOR_RPT_2_pacmod9(STEERING_MOTOR_RPT_2_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENCODER_TEMPERATURE = __ext_sig__(( ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU)) ), 16);
  _m->MOTOR_TEMPERATURE = __ext_sig__(( ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 16);
  ...
  FMon_STEERING_MOTOR_RPT_2_pacmod9(&_m->mon1, STEERING_MOTOR_RPT_2_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_MOTOR_RPT_2_pacmod9(STEERING_MOTOR_RPT_2_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_STEERING_MOTOR_RPT_2_pacmod9(STEERING_MOTOR_RPT_2_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_STEERING_MOTOR_RPT_3_pacmod9(STEERING_MOTOR_RPT_3_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->TORQUE_OUTPUT_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 24) | ((_d[1] & (0xFFU)) << 16) | ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 32);
#ifdef PACMOD9_USE_SIGFLOAT
  ...
  FMon_STEERING_MOTOR_RPT_3_pacmod9(&_m->mon1, STEERING_MOTOR_RPT_3_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_STEERING_MOTOR_RPT_3_pacmod9(STEERING_MOTOR_RPT_3_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_STEERING_MOTOR_RPT_3_pacmod9(STEERING_MOTOR_RPT_3_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_WHEEL_SPEED_RPT_pacmod9(WHEEL_SPEED_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->WHEEL_SPD_FRONT_LEFT_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->WHEEL_SPD_FRONT_LEFT_phys = (sigfloat_t)(PACMOD9_WHEEL_SPD_FRONT_LEFT_ro_fromS(_m->WHEEL_SPD_FRONT_LEFT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->WHEEL_SPD_FRONT_RIGHT_ro = __ext_sig__(( ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->WHEEL_SPD_FRONT_RIGHT_phys = (sigfloat_t)(PACMOD9_WHEEL_SPD_FRONT_RIGHT_ro_fromS(_m->WHEEL_SPD_FRONT_RIGHT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->WHEEL_SPD_REAR_LEFT_ro = __ext_sig__(( ((_d[4] & (0xFFU)) << 8) | (_d[5] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->WHEEL_SPD_REAR_LEFT_phys = (sigfloat_t)(PACMOD9_WHEEL_SPD_REAR_LEFT_ro_fromS(_m->WHEEL_SPD_REAR_LEFT_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->WHEEL_SPD_REAR_RIGHT_ro = __ext_sig__(( ((_d[6] & (0xFFU)) << 8) | (_d[7] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->WHEEL_SPD_REAR_RIGHT_phys = (sigfloat_t)(PACMOD9_WHEEL_SPD_REAR_RIGHT_ro_fromS(_m->WHEEL_SPD_REAR_RIGHT_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_WHEEL_SPEED_RPT_pacmod9(&_m->mon1, WHEEL_SPEED_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_WHEEL_SPEED_RPT_pacmod9(WHEEL_SPEED_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < WHEEL_SPEED_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->WHEEL_SPD_FRONT_LEFT_ro = PACMOD9_WHEEL_SPD_FRONT_LEFT_ro_toS(_m->WHEEL_SPD_FRONT_LEFT_phys);
  _m->WHEEL_SPD_FRONT_RIGHT_ro = PACMOD9_WHEEL_SPD_FRONT_RIGHT_ro_toS(_m->WHEEL_SPD_FRONT_RIGHT_phys);
  _m->WHEEL_SPD_REAR_LEFT_ro = PACMOD9_WHEEL_SPD_REAR_LEFT_ro_toS(_m->WHEEL_SPD_REAR_LEFT_phys);
  _m->WHEEL_SPD_REAR_RIGHT_ro = PACMOD9_WHEEL_SPD_REAR_RIGHT_ro_toS(_m->WHEEL_SPD_REAR_RIGHT_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_WHEEL_SPEED_RPT_pacmod9(WHEEL_SPEED_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SOFTWARE_VERSION_RPT_00_pacmod9(SOFTWARE_VERSION_RPT_00_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->MAJOR = (_d[0] & (0xFFU));
  _m->MINOR = (_d[1] & (0xFFU));
  ...
  FMon_SOFTWARE_VERSION_RPT_00_pacmod9(&_m->mon1, SOFTWARE_VERSION_RPT_00_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SOFTWARE_VERSION_RPT_00_pacmod9(SOFTWARE_VERSION_RPT_00_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SOFTWARE_VERSION_RPT_00_pacmod9(SOFTWARE_VERSION_RPT_00_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SOFTWARE_VERSION_RPT_01_pacmod9(SOFTWARE_VERSION_RPT_01_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->MAJOR = (_d[0] & (0xFFU));
  _m->MINOR = (_d[1] & (0xFFU));
  ...
  FMon_SOFTWARE_VERSION_RPT_01_pacmod9(&_m->mon1, SOFTWARE_VERSION_RPT_01_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SOFTWARE_VERSION_RPT_01_pacmod9(SOFTWARE_VERSION_RPT_01_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SOFTWARE_VERSION_RPT_01_pacmod9(SOFTWARE_VERSION_RPT_01_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SOFTWARE_VERSION_RPT_02_pacmod9(SOFTWARE_VERSION_RPT_02_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->MAJOR = (_d[0] & (0xFFU));
  _m->MINOR = (_d[1] & (0xFFU));
  ...
  FMon_SOFTWARE_VERSION_RPT_02_pacmod9(&_m->mon1, SOFTWARE_VERSION_RPT_02_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SOFTWARE_VERSION_RPT_02_pacmod9(SOFTWARE_VERSION_RPT_02_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SOFTWARE_VERSION_RPT_02_pacmod9(SOFTWARE_VERSION_RPT_02_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_SOFTWARE_VERSION_RPT_03_pacmod9(SOFTWARE_VERSION_RPT_03_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->MAJOR = (_d[0] & (0xFFU));
  _m->MINOR = (_d[1] & (0xFFU));
  ...
  FMon_SOFTWARE_VERSION_RPT_03_pacmod9(&_m->mon1, SOFTWARE_VERSION_RPT_03_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_SOFTWARE_VERSION_RPT_03_pacmod9(SOFTWARE_VERSION_RPT_03_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_SOFTWARE_VERSION_RPT_03_pacmod9(SOFTWARE_VERSION_RPT_03_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_YAW_RATE_RPT_pacmod9(YAW_RATE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->YAW_RATE_ro = __ext_sig__(( ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->YAW_RATE_phys = (sigfloat_t)(PACMOD9_YAW_RATE_ro_fromS(_m->YAW_RATE_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_YAW_RATE_RPT_pacmod9(&_m->mon1, YAW_RATE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_YAW_RATE_RPT_pacmod9(YAW_RATE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < YAW_RATE_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->YAW_RATE_ro = PACMOD9_YAW_RATE_ro_toS(_m->YAW_RATE_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_YAW_RATE_RPT_pacmod9(YAW_RATE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_LAT_LON_HEADING_RPT_pacmod9(LAT_LON_HEADING_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->HEADING_phys = (sigfloat_t)(PACMOD9_HEADING_ro_fromS(_m->HEADING_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_LAT_LON_HEADING_RPT_pacmod9(&_m->mon1, LAT_LON_HEADING_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_LAT_LON_HEADING_RPT_pacmod9(LAT_LON_HEADING_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < LAT_LON_HEADING_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->HEADING_ro = PACMOD9_HEADING_ro_toS(_m->HEADING_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_LAT_LON_HEADING_RPT_pacmod9(LAT_LON_HEADING_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DATE_TIME_RPT_pacmod9(DATE_TIME_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->DATE_YEAR_ro = (_d[0] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->DATE_YEAR_phys = PACMOD9_DATE_YEAR_ro_fromS(_m->DATE_YEAR_ro);
#endif // PACMOD9_USE_SIGFLOAT

  _m->DATE_MONTH_ro = (_d[1] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->DATE_MONTH_phys = PACMOD9_DATE_MONTH_ro_fromS(_m->DATE_MONTH_ro);
#endif // PACMOD9_USE_SIGFLOAT

  _m->DATE_DAY_ro = (_d[2] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->DATE_DAY_phys = PACMOD9_DATE_DAY_ro_fromS(_m->DATE_DAY_ro);
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_DATE_TIME_RPT_pacmod9(&_m->mon1, DATE_TIME_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DATE_TIME_RPT_pacmod9(DATE_TIME_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < DATE_TIME_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->DATE_YEAR_ro = PACMOD9_DATE_YEAR_ro_toS(_m->DATE_YEAR_phys);
  _m->DATE_MONTH_ro = PACMOD9_DATE_MONTH_ro_toS(_m->DATE_MONTH_phys);
  _m->DATE_DAY_ro = PACMOD9_DATE_DAY_ro_toS(_m->DATE_DAY_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_DATE_TIME_RPT_pacmod9(DATE_TIME_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ENGINE_RPT_pacmod9(ENGINE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ENGINE_SPEED_ro = ((_d[0] & (0xFFU)) << 8) | (_d[1] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ENGINE_SPEED_phys = (sigfloat_t)(PACMOD9_ENGINE_SPEED_ro_fromS(_m->ENGINE_SPEED_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->ENGINE_TORQUE_ro = ((_d[2] & (0xFFU)) << 8) | (_d[3] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ENGINE_TORQUE_phys = (sigfloat_t)(PACMOD9_ENGINE_TORQUE_ro_fromS(_m->ENGINE_TORQUE_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->ENGINE_COOLANT_TEMP_ro = (_d[4] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ENGINE_COOLANT_TEMP_phys = PACMOD9_ENGINE_COOLANT_TEMP_ro_fromS(_m->ENGINE_COOLANT_TEMP_ro);
#endif // PACMOD9_USE_SIGFLOAT
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->FUEL_LEVEL_phys = (sigfloat_t)(PACMOD9_FUEL_LEVEL_ro_fromS(_m->FUEL_LEVEL_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_ENGINE_RPT_pacmod9(&_m->mon1, ENGINE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ENGINE_RPT_pacmod9(ENGINE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < ENGINE_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->ENGINE_SPEED_ro = PACMOD9_ENGINE_SPEED_ro_toS(_m->ENGINE_SPEED_phys);
  _m->ENGINE_TORQUE_ro = PACMOD9_ENGINE_TORQUE_ro_toS(_m->ENGINE_TORQUE_phys);
  _m->ENGINE_COOLANT_TEMP_ro = PACMOD9_ENGINE_COOLANT_TEMP_ro_toS(_m->ENGINE_COOLANT_TEMP_phys);
  _m->FUEL_LEVEL_ro = PACMOD9_FUEL_LEVEL_ro_toS(_m->FUEL_LEVEL_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_ENGINE_RPT_pacmod9(ENGINE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DETECTED_OBJECT_RPT_pacmod9(DETECTED_OBJECT_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->FRONT_OBJECT_DISTANCE_LOW_RES_ro = ((_d[0] & (0xFFU)) << 16) | ((_d[1] & (0xFFU)) << 8) | (_d[2] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->FRONT_OBJECT_DISTANCE_LOW_RES_phys = (sigfloat_t)(PACMOD9_FRONT_OBJECT_DISTANCE_LOW_RES_ro_fromS(_m->FRONT_OBJECT_DISTANCE_LOW_RES_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->FRONT_OBJECT_DISTANCE_HIGH_RES_ro = ((_d[3] & (0xFFU)) << 16) | ((_d[4] & (0xFFU)) << 8) | (_d[5] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->FRONT_OBJECT_DISTANCE_HIGH_RES_phys = (sigfloat_t)(PACMOD9_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_fromS(_m->FRONT_OBJECT_DISTANCE_HIGH_RES_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_DETECTED_OBJECT_RPT_pacmod9(&_m->mon1, DETECTED_OBJECT_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DETECTED_OBJECT_RPT_pacmod9(DETECTED_OBJECT_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < DETECTED_OBJECT_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->FRONT_OBJECT_DISTANCE_LOW_RES_ro = PACMOD9_FRONT_OBJECT_DISTANCE_LOW_RES_ro_toS(_m->FRONT_OBJECT_DISTANCE_LOW_RES_phys);
  _m->FRONT_OBJECT_DISTANCE_HIGH_RES_ro = PACMOD9_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_toS(_m->FRONT_OBJECT_DISTANCE_HIGH_RES_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_DETECTED_OBJECT_RPT_pacmod9(DETECTED_OBJECT_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_VEH_SPECIFIC_RPT_1_pacmod9(VEH_SPECIFIC_RPT_1_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_VEH_SPECIFIC_RPT_1_pacmod9(&_m->mon1, VEH_SPECIFIC_RPT_1_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_VEH_SPECIFIC_RPT_1_pacmod9(VEH_SPECIFIC_RPT_1_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_VEH_SPECIFIC_RPT_1_pacmod9(VEH_SPECIFIC_RPT_1_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_VEH_DYNAMICS_RPT_pacmod9(VEH_DYNAMICS_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->VEH_G_FORCES_ro = (_d[0] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->VEH_G_FORCES_phys = (sigfloat_t)(PACMOD9_VEH_G_FORCES_ro_fromS(_m->VEH_G_FORCES_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_VEH_DYNAMICS_RPT_pacmod9(&_m->mon1, VEH_DYNAMICS_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_VEH_DYNAMICS_RPT_pacmod9(VEH_DYNAMICS_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < VEH_DYNAMICS_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->VEH_G_FORCES_ro = PACMOD9_VEH_G_FORCES_ro_toS(_m->VEH_G_FORCES_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_VEH_DYNAMICS_RPT_pacmod9(VEH_DYNAMICS_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_VIN_RPT_pacmod9(VIN_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_VIN_RPT_pacmod9(&_m->mon1, VIN_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_VIN_RPT_pacmod9(VIN_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_VIN_RPT_pacmod9(VIN_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_OCCUPANCY_RPT_pacmod9(OCCUPANCY_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  _m->DRIVER_REAR_SEATBELT_BUCKLED = ((_d[0] >> 5) & (0x01U));
  _m->PASS_REAR_SEATBELT_BUCKLED = ((_d[0] >> 6) & (0x01U));
  _m->CENTER_REAR_SEATBELT_BUCKLED = ((_d[0] >> 7) & (0x01U));
  ...
  _m->DRIVER_REAR_SEATBELT_BUCKLED_AVAIL = ((_d[1] >> 5) & (0x01U));
  _m->PASS_REAR_SEATBELT_BUCKLED_AVAIL = ((_d[1] >> 6) & (0x01U));
  _m->CENTER_REAR_SEATBELT_BUCKLED_AVAIL = ((_d[1] >> 7) & (0x01U));
  ...
  FMon_OCCUPANCY_RPT_pacmod9(&_m->mon1, OCCUPANCY_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_OCCUPANCY_RPT_pacmod9(OCCUPANCY_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < OCCUPANCY_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

  cframe->Data[0] |= (_m->DRIVER_SEAT_OCCUPIED & (0x01U)) | ((_m->PASS_SEAT_OCCUPIED & (0x01U)) << 1) | ((_m->REAR_SEAT_OCCUPIED & (0x01U)) << 2) | ((_m->DRIVER_SEATBELT_BUCKLED & (0x01U)) << 3) | ((_m->PASS_SEATBELT_BUCKLED & (0x01U)) << 4) | ((_m->DRIVER_REAR_SEATBELT_BUCKLED & (0x01U)) << 5) | ((_m->PASS_REAR_SEATBELT_BUCKLED & (0x01U)) << 6) | ((_m->CENTER_REAR_SEATBELT_BUCKLED & (0x01U)) << 7);
  cframe->Data[1] |= (_m->DRIVER_SEAT_OCCUPIED_AVAIL & (0x01U)) | ((_m->PASS_SEAT_OCCUPIED_AVAIL & (0x01U)) << 1) | ((_m->REAR_SEAT_OCCUPIED_AVAIL & (0x01U)) << 2) | ((_m->DRIVER_SEATBELT_BUCKLED_AVAIL & (0x01U)) << 3) | ((_m->PASS_SEATBELT_BUCKLED_AVAIL & (0x01U)) << 4) | ((_m->DRIVER_REAR_SEATBELT_BUCKLED_AVAIL & (0x01U)) << 5) | ((_m->PASS_REAR_SEATBELT_BUCKLED_AVAIL & (0x01U)) << 6) | ((_m->CENTER_REAR_SEATBELT_BUCKLED_AVAIL & (0x01U)) << 7);
...
uint32_t Pack_OCCUPANCY_RPT_pacmod9(OCCUPANCY_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < OCCUPANCY_RPT_DLC) && (i < 8); _d[i++] = 0);

  _d[0] |= (_m->DRIVER_SEAT_OCCUPIED & (0x01U)) | ((_m->PASS_SEAT_OCCUPIED & (0x01U)) << 1) | ((_m->REAR_SEAT_OCCUPIED & (0x01U)) << 2) | ((_m->DRIVER_SEATBELT_BUCKLED & (0x01U)) << 3) | ((_m->PASS_SEATBELT_BUCKLED & (0x01U)) << 4) | ((_m->DRIVER_REAR_SEATBELT_BUCKLED & (0x01U)) << 5) | ((_m->PASS_REAR_SEATBELT_BUCKLED & (0x01U)) << 6) | ((_m->CENTER_REAR_SEATBELT_BUCKLED & (0x01U)) << 7);
...
uint32_t Unpack_INTERIOR_LIGHTS_RPT_pacmod9(INTERIOR_LIGHTS_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_INTERIOR_LIGHTS_RPT_pacmod9(&_m->mon1, INTERIOR_LIGHTS_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_INTERIOR_LIGHTS_RPT_pacmod9(INTERIOR_LIGHTS_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_INTERIOR_LIGHTS_RPT_pacmod9(INTERIOR_LIGHTS_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DOOR_RPT_pacmod9(DOOR_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_DOOR_RPT_pacmod9(&_m->mon1, DOOR_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_DOOR_RPT_pacmod9(DOOR_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_DOOR_RPT_pacmod9(DOOR_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_REAR_LIGHTS_RPT_pacmod9(REAR_LIGHTS_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_REAR_LIGHTS_RPT_pacmod9(&_m->mon1, REAR_LIGHTS_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_REAR_LIGHTS_RPT_pacmod9(REAR_LIGHTS_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_REAR_LIGHTS_RPT_pacmod9(REAR_LIGHTS_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_LINEAR_ACCEL_RPT_pacmod9(LINEAR_ACCEL_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->LATERAL_ACCEL_phys = (sigfloat_t)(PACMOD9_LATERAL_ACCEL_ro_fromS(_m->LATERAL_ACCEL_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->LONGITUDNAL_ACCEL_ro = __ext_sig__(( ((_d[3] & (0xFFU)) << 8) | (_d[4] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->LONGITUDNAL_ACCEL_phys = (sigfloat_t)(PACMOD9_LONGITUDNAL_ACCEL_ro_fromS(_m->LONGITUDNAL_ACCEL_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->VERTICAL_ACCEL_ro = __ext_sig__(( ((_d[5] & (0xFFU)) << 8) | (_d[6] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->VERTICAL_ACCEL_phys = (sigfloat_t)(PACMOD9_VERTICAL_ACCEL_ro_fromS(_m->VERTICAL_ACCEL_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_LINEAR_ACCEL_RPT_pacmod9(&_m->mon1, LINEAR_ACCEL_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_LINEAR_ACCEL_RPT_pacmod9(LINEAR_ACCEL_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < LINEAR_ACCEL_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->LATERAL_ACCEL_ro = PACMOD9_LATERAL_ACCEL_ro_toS(_m->LATERAL_ACCEL_phys);
  _m->LONGITUDNAL_ACCEL_ro = PACMOD9_LONGITUDNAL_ACCEL_ro_toS(_m->LONGITUDNAL_ACCEL_phys);
  _m->VERTICAL_ACCEL_ro = PACMOD9_VERTICAL_ACCEL_ro_toS(_m->VERTICAL_ACCEL_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_LINEAR_ACCEL_RPT_pacmod9(LINEAR_ACCEL_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ANG_VEL_RPT_pacmod9(ANG_VEL_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
...
#ifdef PACMOD9_USE_SIGFLOAT
  _m->PITCH_VEL_phys = (sigfloat_t)(PACMOD9_PITCH_VEL_ro_fromS(_m->PITCH_VEL_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->ROLL_VEL_ro = __ext_sig__(( ((_d[3] & (0xFFU)) << 8) | (_d[4] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->ROLL_VEL_phys = (sigfloat_t)(PACMOD9_ROLL_VEL_ro_fromS(_m->ROLL_VEL_ro));
#endif // PACMOD9_USE_SIGFLOAT

  _m->YAW_VEL_ro = __ext_sig__(( ((_d[5] & (0xFFU)) << 8) | (_d[6] & (0xFFU)) ), 16);
#ifdef PACMOD9_USE_SIGFLOAT
  _m->YAW_VEL_phys = (sigfloat_t)(PACMOD9_YAW_VEL_ro_fromS(_m->YAW_VEL_ro));
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_ANG_VEL_RPT_pacmod9(&_m->mon1, ANG_VEL_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ANG_VEL_RPT_pacmod9(ANG_VEL_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < ANG_VEL_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->PITCH_VEL_ro = PACMOD9_PITCH_VEL_ro_toS(_m->PITCH_VEL_phys);
  _m->ROLL_VEL_ro = PACMOD9_ROLL_VEL_ro_toS(_m->ROLL_VEL_phys);
  _m->YAW_VEL_ro = PACMOD9_YAW_VEL_ro_toS(_m->YAW_VEL_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_ANG_VEL_RPT_pacmod9(ANG_VEL_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_NOTIFICATION_CMD_pacmod9(NOTIFICATION_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_NOTIFICATION_CMD_pacmod9(&_m->mon1, NOTIFICATION_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_NOTIFICATION_CMD_pacmod9(NOTIFICATION_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_NOTIFICATION_CMD_pacmod9(NOTIFICATION_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_ESTOP_RPT_pacmod9(ESTOP_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->ESTOP = (_d[0] & (0x01U));
  ...
  FMon_ESTOP_RPT_pacmod9(&_m->mon1, ESTOP_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_ESTOP_RPT_pacmod9(ESTOP_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_ESTOP_RPT_pacmod9(ESTOP_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_USER_NOTIFICATION_CMD_pacmod9(USER_NOTIFICATION_CMD_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->BUZZER_MUTE = (_d[0] & (0x01U));
  _m->UNDERDASH_LIGHTS_WHITE = ((_d[0] >> 1) & (0x01U));
  ...
  FMon_USER_NOTIFICATION_CMD_pacmod9(&_m->mon1, USER_NOTIFICATION_CMD_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_USER_NOTIFICATION_CMD_pacmod9(USER_NOTIFICATION_CMD_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_USER_NOTIFICATION_CMD_pacmod9(USER_NOTIFICATION_CMD_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_TIRE_PRESSURE_RPT_pacmod9(TIRE_PRESSURE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  _m->FRONT_LEFT_TIRE_PRESSURE_ro = (_d[0] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->FRONT_LEFT_TIRE_PRESSURE_phys = PACMOD9_FRONT_LEFT_TIRE_PRESSURE_ro_fromS(_m->FRONT_LEFT_TIRE_PRESSURE_ro);
#endif // PACMOD9_USE_SIGFLOAT

  _m->FRONT_RIGHT_TIRE_PRESSURE_ro = (_d[1] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->FRONT_RIGHT_TIRE_PRESSURE_phys = PACMOD9_FRONT_RIGHT_TIRE_PRESSURE_ro_fromS(_m->FRONT_RIGHT_TIRE_PRESSURE_ro);
#endif // PACMOD9_USE_SIGFLOAT

  _m->REAR_LEFT_TIRE_PRESSURE_ro = (_d[2] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->REAR_LEFT_TIRE_PRESSURE_phys = PACMOD9_REAR_LEFT_TIRE_PRESSURE_ro_fromS(_m->REAR_LEFT_TIRE_PRESSURE_ro);
#endif // PACMOD9_USE_SIGFLOAT

  _m->REAR_RIGHT_TIRE_PRESSURE_ro = (_d[3] & (0xFFU));
#ifdef PACMOD9_USE_SIGFLOAT
  _m->REAR_RIGHT_TIRE_PRESSURE_phys = PACMOD9_REAR_RIGHT_TIRE_PRESSURE_ro_fromS(_m->REAR_RIGHT_TIRE_PRESSURE_ro);
#endif // PACMOD9_USE_SIGFLOAT
  ...
  FMon_TIRE_PRESSURE_RPT_pacmod9(&_m->mon1, TIRE_PRESSURE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_TIRE_PRESSURE_RPT_pacmod9(TIRE_PRESSURE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < TIRE_PRESSURE_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);

#ifdef PACMOD9_USE_SIGFLOAT
  _m->FRONT_LEFT_TIRE_PRESSURE_ro = PACMOD9_FRONT_LEFT_TIRE_PRESSURE_ro_toS(_m->FRONT_LEFT_TIRE_PRESSURE_phys);
  _m->FRONT_RIGHT_TIRE_PRESSURE_ro = PACMOD9_FRONT_RIGHT_TIRE_PRESSURE_ro_toS(_m->FRONT_RIGHT_TIRE_PRESSURE_phys);
  _m->REAR_LEFT_TIRE_PRESSURE_ro = PACMOD9_REAR_LEFT_TIRE_PRESSURE_ro_toS(_m->REAR_LEFT_TIRE_PRESSURE_phys);
  _m->REAR_RIGHT_TIRE_PRESSURE_ro = PACMOD9_REAR_RIGHT_TIRE_PRESSURE_ro_toS(_m->REAR_RIGHT_TIRE_PRESSURE_phys);
#endif // PACMOD9_USE_SIGFLOAT
...
uint32_t Pack_TIRE_PRESSURE_RPT_pacmod9(TIRE_PRESSURE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
...
uint32_t Unpack_DRIVE_TRAIN_FEATURE_ACTIVE_RPT_pacmod9(DRIVE_TRAIN_FEATURE_ACTIVE_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
...
#ifdef PACMOD9_USE_DIAG_MONITORS
  _m->mon1.dlc_error = (dlc_ < DRIVE_TRAIN_FEATURE_ACTIVE_RPT_DLC);
  _m->mon1.last_cycle = GetSystemTick();
  _m->mon1.frame_cnt++;

  FMon_DRIVE_TRAIN_FEATURE_ACTIVE_RPT_pacmod9(&_m->mon1, DRIVE_TRAIN_FEATURE_ACTIVE_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS

  return DRIVE_TRAIN_FEATURE_ACTIVE_RPT_CANID;
}

#ifdef PACMOD9_USE_CANSTRUCT

uint32_t Pack_DRIVE_TRAIN_FEATURE_ACTIVE_RPT_pacmod9(DRIVE_TRAIN_FEATURE_ACTIVE_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
  uint8_t i; for (i = 0; (i < DRIVE_TRAIN_FEATURE_ACTIVE_RPT_DLC) && (i < 8); cframe->Data[i++] = 0);
  ...
  cframe->MsgId = DRIVE_TRAIN_FEATURE_ACTIVE_RPT_CANID;
  cframe->DLC = DRIVE_TRAIN_FEATURE_ACTIVE_RPT_DLC;
  cframe->IDE = DRIVE_TRAIN_FEATURE_ACTIVE_RPT_IDE;
  return DRIVE_TRAIN_FEATURE_ACTIVE_RPT_CANID;
}

#else

uint32_t Pack_DRIVE_TRAIN_FEATURE_ACTIVE_RPT_pacmod9(DRIVE_TRAIN_FEATURE_ACTIVE_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
  uint8_t i; for (i = 0; (i < DRIVE_TRAIN_FEATURE_ACTIVE_RPT_DLC) && (i < 8); _d[i++] = 0);
  ...
  *_len = DRIVE_TRAIN_FEATURE_ACTIVE_RPT_DLC;
  *_ide = DRIVE_TRAIN_FEATURE_ACTIVE_RPT_IDE;
  return DRIVE_TRAIN_FEATURE_ACTIVE_RPT_CANID;
}

#endif // PACMOD9_USE_CANSTRUCT

uint32_t Unpack_WATCHDOG_RPT_pacmod9(WATCHDOG_RPT_t* _m, const uint8_t* _d, uint8_t dlc_)
{
  (void)dlc_;
  ...
  FMon_WATCHDOG_RPT_pacmod9(&_m->mon1, WATCHDOG_RPT_CANID);
#endif // PACMOD9_USE_DIAG_MONITORS
...
uint32_t Pack_WATCHDOG_RPT_pacmod9(WATCHDOG_RPT_t* _m, __CoderDbcCanFrame_t__* cframe)
{
...
uint32_t Pack_WATCHDOG_RPT_pacmod9(WATCHDOG_RPT_t* _m, uint8_t* _d, uint8_t* _len, uint8_t* _ide)
{
