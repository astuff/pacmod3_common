...
// DBC file version
#define VER_PACMOD11_MAJ (0U)
#define VER_PACMOD11_MIN (0U)

// include current dbc-driver compilation config
#include "pacmod11-config.h"
...
typedef struct
{
#ifdef PACMOD11_USE_BITS_SIGNAL
...
#endif // PACMOD11_USE_BITS_SIGNAL
...
// signal: @ACCEL_CMD_ro
#define PACMOD11_ACCEL_CMD_ro_CovFactor (0.001000)
#define PACMOD11_ACCEL_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_ACCEL_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @BRAKE_CMD_ro
#define PACMOD11_BRAKE_CMD_ro_CovFactor (0.001000)
#define PACMOD11_BRAKE_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_BRAKE_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @POSITION_ro
#define PACMOD11_POSITION_ro_CovFactor (0.001000)
#define PACMOD11_POSITION_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_POSITION_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROTATION_RATE_ro
#define PACMOD11_ROTATION_RATE_ro_CovFactor (0.001000)
#define PACMOD11_ROTATION_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_ROTATION_RATE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_BRAKE_DECEL_CMD_ro_CovFactor (0.001000)
#define PACMOD11_BRAKE_DECEL_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_BRAKE_DECEL_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
typedef struct
{
  ...
  // Brake aggressiveness increases with increasing numerical values. Each operator control setting maps one-to-one with each LEVEL, starting with 1. Higher LEVELs with no match map to maximum. Braking aggressiveness automatic with AUTO.
  //  0 : "OFF"
  //  1 : "LEVEL_1"
  //  2 : "LEVEL_2"
  //  3 : "LEVEL_3"
...
#define PACMOD11_CABIN_TEMP_CMD_ro_CovFactor (0.100000)
#define PACMOD11_CABIN_TEMP_CMD_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD11_CABIN_TEMP_CMD_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
...
#define PACMOD11_MANUAL_INPUT_ro_CovFactor (0.001000)
#define PACMOD11_MANUAL_INPUT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_MANUAL_INPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @COMMANDED_VALUE_ro
#define PACMOD11_COMMANDED_VALUE_ro_CovFactor (0.001000)
#define PACMOD11_COMMANDED_VALUE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_COMMANDED_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @OUTPUT_VALUE_ro
#define PACMOD11_OUTPUT_VALUE_ro_CovFactor (0.001000)
#define PACMOD11_OUTPUT_VALUE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_OUTPUT_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_ACCEL_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD11_ACCEL_CMD_LIMIT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_ACCEL_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_ACCEL_CMD_ro
#define PACMOD11_LIMITED_ACCEL_CMD_ro_CovFactor (0.001000)
#define PACMOD11_LIMITED_ACCEL_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_LIMITED_ACCEL_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_BRAKE_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD11_BRAKE_CMD_LIMIT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_BRAKE_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_BRAKE_CMD_ro
#define PACMOD11_LIMITED_BRAKE_CMD_ro_CovFactor (0.001000)
#define PACMOD11_LIMITED_BRAKE_CMD_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_LIMITED_BRAKE_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @MANUAL_INPUT_ro
#define PACMOD11_MANUAL_INPUT_ro_CovFactor (0.001000)
#define PACMOD11_MANUAL_INPUT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_MANUAL_INPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @COMMANDED_VALUE_ro
#define PACMOD11_COMMANDED_VALUE_ro_CovFactor (0.001000)
#define PACMOD11_COMMANDED_VALUE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_COMMANDED_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @OUTPUT_VALUE_ro
#define PACMOD11_OUTPUT_VALUE_ro_CovFactor (0.001000)
#define PACMOD11_OUTPUT_VALUE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_OUTPUT_VALUE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_POSITION_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD11_POSITION_CMD_LIMIT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_POSITION_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_POSITION_CMD_ro
#define PACMOD11_LIMITED_POSITION_CMD_ro_CovFactor (0.001000)
#define PACMOD11_LIMITED_POSITION_CMD_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_LIMITED_POSITION_CMD_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROTATION_RATE_CMD_LIMIT_ro
#define PACMOD11_ROTATION_RATE_CMD_LIMIT_ro_CovFactor (0.001000)
#define PACMOD11_ROTATION_RATE_CMD_LIMIT_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_ROTATION_RATE_CMD_LIMIT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @LIMITED_ROTATION_RATE_ro
#define PACMOD11_LIMITED_ROTATION_RATE_ro_CovFactor (0.001000)
#define PACMOD11_LIMITED_ROTATION_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_LIMITED_ROTATION_RATE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
// signal: @MANUAL_INPUT_ro
#define PACMOD11_MANUAL_INPUT_ro_CovFactor (0.100000)
#define PACMOD11_MANUAL_INPUT_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD11_MANUAL_INPUT_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
// signal: @COMMANDED_VALUE_ro
#define PACMOD11_COMMANDED_VALUE_ro_CovFactor (0.100000)
#define PACMOD11_COMMANDED_VALUE_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD11_COMMANDED_VALUE_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
// signal: @OUTPUT_VALUE_ro
#define PACMOD11_OUTPUT_VALUE_ro_CovFactor (0.100000)
#define PACMOD11_OUTPUT_VALUE_ro_toS(x) ( (uint8_t) (((x) - (10.000000)) / (0.100000)) )
#define PACMOD11_OUTPUT_VALUE_ro_fromS(x) ( (((x) * (0.100000)) + (10.000000)) )
...
#define PACMOD11_BRAKE_PRESSURE_ro_CovFactor (0.000100)
#define PACMOD11_BRAKE_PRESSURE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.000100)) )
#define PACMOD11_BRAKE_PRESSURE_ro_fromS(x) ( (((x) * (0.000100)) + (0.000000)) )
...
typedef struct
{
  ...
  //  0 : "NOT_AVAILABLE"
  //  1 : "AVAILABLE"
  uint8_t SHIFT_MODE_AVIAL : 1;               //      Bits= 1
  ...
  //  0 : "NOT_AVAILABLE"
  //  1 : "AVAILABLE"
  uint8_t SHIFT_MODE_AVIAL;                   //      Bits= 1
...
#define PACMOD11_STEERING_TORQUE_ro_CovFactor (0.000100)
#define PACMOD11_STEERING_TORQUE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.000100)) )
#define PACMOD11_STEERING_TORQUE_ro_fromS(x) ( (((x) * (0.000100)) + (0.000000)) )
// signal: @ROTATION_RATE_ro
#define PACMOD11_ROTATION_RATE_ro_CovFactor (0.001000)
#define PACMOD11_ROTATION_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_ROTATION_RATE_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_ACTUAL_ENGINE_BRK_TORQUE_ro_CovFactor (1)
#define PACMOD11_ACTUAL_ENGINE_BRK_TORQUE_ro_toS(x) ( (int8_t) ((x) - (-125)) )
#define PACMOD11_ACTUAL_ENGINE_BRK_TORQUE_ro_fromS(x) ( ((x) + (-125)) )
// signal: @INTENDED_ENGINE_BRK_TORQUE_ro
#define PACMOD11_INTENDED_ENGINE_BRK_TORQUE_ro_CovFactor (1)
#define PACMOD11_INTENDED_ENGINE_BRK_TORQUE_ro_toS(x) ( (int8_t) ((x) - (-125)) )
#define PACMOD11_INTENDED_ENGINE_BRK_TORQUE_ro_fromS(x) ( ((x) + (-125)) )
...
#define PACMOD11_VEHICLE_SPEED_ro_CovFactor (0.010000)
#define PACMOD11_VEHICLE_SPEED_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_VEHICLE_SPEED_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
#define PACMOD11_MOTOR_CURRENT_ro_CovFactor (0.001000)
#define PACMOD11_MOTOR_CURRENT_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_MOTOR_CURRENT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @SHAFT_POSITION_ro
#define PACMOD11_SHAFT_POSITION_ro_CovFactor (0.001000)
#define PACMOD11_SHAFT_POSITION_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_SHAFT_POSITION_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_ANGULAR_SPEED_ro_CovFactor (0.100000)
#define PACMOD11_ANGULAR_SPEED_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.100000)) )
#define PACMOD11_ANGULAR_SPEED_ro_fromS(x) ( (((x) * (0.100000)) + (0.000000)) )
...
#define PACMOD11_TORQUE_OUTPUT_ro_CovFactor (0.001000)
#define PACMOD11_TORQUE_OUTPUT_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_TORQUE_OUTPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @TORQUE_INPUT_ro
#define PACMOD11_TORQUE_INPUT_ro_CovFactor (0.001000)
#define PACMOD11_TORQUE_INPUT_ro_toS(x) ( (int32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_TORQUE_INPUT_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_WHEEL_SPD_FRONT_LEFT_ro_CovFactor (0.010000)
#define PACMOD11_WHEEL_SPD_FRONT_LEFT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_WHEEL_SPD_FRONT_LEFT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @WHEEL_SPD_FRONT_RIGHT_ro
#define PACMOD11_WHEEL_SPD_FRONT_RIGHT_ro_CovFactor (0.010000)
#define PACMOD11_WHEEL_SPD_FRONT_RIGHT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_WHEEL_SPD_FRONT_RIGHT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @WHEEL_SPD_REAR_LEFT_ro
#define PACMOD11_WHEEL_SPD_REAR_LEFT_ro_CovFactor (0.010000)
#define PACMOD11_WHEEL_SPD_REAR_LEFT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_WHEEL_SPD_REAR_LEFT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @WHEEL_SPD_REAR_RIGHT_ro
#define PACMOD11_WHEEL_SPD_REAR_RIGHT_ro_CovFactor (0.010000)
#define PACMOD11_WHEEL_SPD_REAR_RIGHT_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_WHEEL_SPD_REAR_RIGHT_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @YAW_RATE_ro
#define PACMOD11_YAW_RATE_ro_CovFactor (0.010000)
#define PACMOD11_YAW_RATE_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_YAW_RATE_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @HEADING_ro
#define PACMOD11_HEADING_ro_CovFactor (0.010000)
#define PACMOD11_HEADING_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_HEADING_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @DATE_YEAR_ro
#define PACMOD11_DATE_YEAR_ro_CovFactor (1)
#define PACMOD11_DATE_YEAR_ro_toS(x) ( (uint8_t) ((x) - (2000)) )
#define PACMOD11_DATE_YEAR_ro_fromS(x) ( ((x) + (2000)) )
// signal: @DATE_MONTH_ro
#define PACMOD11_DATE_MONTH_ro_CovFactor (1)
#define PACMOD11_DATE_MONTH_ro_toS(x) ( (uint8_t) ((x) - (1)) )
#define PACMOD11_DATE_MONTH_ro_fromS(x) ( ((x) + (1)) )
// signal: @DATE_DAY_ro
#define PACMOD11_DATE_DAY_ro_CovFactor (1)
#define PACMOD11_DATE_DAY_ro_toS(x) ( (uint8_t) ((x) - (1)) )
#define PACMOD11_DATE_DAY_ro_fromS(x) ( ((x) + (1)) )
...
#define PACMOD11_ENGINE_SPEED_ro_CovFactor (0.250000)
#define PACMOD11_ENGINE_SPEED_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.250000)) )
#define PACMOD11_ENGINE_SPEED_ro_fromS(x) ( (((x) * (0.250000)) + (0.000000)) )
// signal: @ENGINE_TORQUE_ro
#define PACMOD11_ENGINE_TORQUE_ro_CovFactor (0.062500)
#define PACMOD11_ENGINE_TORQUE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.062500)) )
#define PACMOD11_ENGINE_TORQUE_ro_fromS(x) ( (((x) * (0.062500)) + (0.000000)) )
// signal: @ENGINE_COOLANT_TEMP_ro
#define PACMOD11_ENGINE_COOLANT_TEMP_ro_CovFactor (1)
#define PACMOD11_ENGINE_COOLANT_TEMP_ro_toS(x) ( (uint8_t) ((x) - (-40)) )
#define PACMOD11_ENGINE_COOLANT_TEMP_ro_fromS(x) ( ((x) + (-40)) )
// signal: @FUEL_LEVEL_ro
#define PACMOD11_FUEL_LEVEL_ro_CovFactor (0.005000)
#define PACMOD11_FUEL_LEVEL_ro_toS(x) ( (uint8_t) (((x) - (0.000000)) / (0.005000)) )
#define PACMOD11_FUEL_LEVEL_ro_fromS(x) ( (((x) * (0.005000)) + (0.000000)) )
...
#define PACMOD11_FRONT_OBJECT_DISTANCE_LOW_RES_ro_CovFactor (0.001000)
#define PACMOD11_FRONT_OBJECT_DISTANCE_LOW_RES_ro_toS(x) ( (uint32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_FRONT_OBJECT_DISTANCE_LOW_RES_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @FRONT_OBJECT_DISTANCE_HIGH_RES_ro
#define PACMOD11_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_CovFactor (0.001000)
#define PACMOD11_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_toS(x) ( (uint32_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_FRONT_OBJECT_DISTANCE_HIGH_RES_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_VEH_G_FORCES_ro_CovFactor (0.001000)
#define PACMOD11_VEH_G_FORCES_ro_toS(x) ( (uint8_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_VEH_G_FORCES_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_LATERAL_ACCEL_ro_CovFactor (0.010000)
#define PACMOD11_LATERAL_ACCEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_LATERAL_ACCEL_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @LONGITUDINAL_ACCEL_ro
#define PACMOD11_LONGITUDINAL_ACCEL_ro_CovFactor (0.010000)
#define PACMOD11_LONGITUDINAL_ACCEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_LONGITUDINAL_ACCEL_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
// signal: @VERTICAL_ACCEL_ro
#define PACMOD11_VERTICAL_ACCEL_ro_CovFactor (0.010000)
#define PACMOD11_VERTICAL_ACCEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.010000)) )
#define PACMOD11_VERTICAL_ACCEL_ro_fromS(x) ( (((x) * (0.010000)) + (0.000000)) )
...
// signal: @PITCH_VEL_ro
#define PACMOD11_PITCH_VEL_ro_CovFactor (0.001000)
#define PACMOD11_PITCH_VEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_PITCH_VEL_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @ROLL_VEL_ro
#define PACMOD11_ROLL_VEL_ro_CovFactor (0.001000)
#define PACMOD11_ROLL_VEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_ROLL_VEL_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
// signal: @YAW_VEL_ro
#define PACMOD11_YAW_VEL_ro_CovFactor (0.001000)
#define PACMOD11_YAW_VEL_ro_toS(x) ( (int16_t) (((x) - (0.000000)) / (0.001000)) )
#define PACMOD11_YAW_VEL_ro_fromS(x) ( (((x) * (0.001000)) + (0.000000)) )
...
#define PACMOD11_FRONT_LEFT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD11_FRONT_LEFT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD11_FRONT_LEFT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
// signal: @FRONT_RIGHT_TIRE_PRESSURE_ro
#define PACMOD11_FRONT_RIGHT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD11_FRONT_RIGHT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD11_FRONT_RIGHT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
// signal: @REAR_LEFT_TIRE_PRESSURE_ro
#define PACMOD11_REAR_LEFT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD11_REAR_LEFT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD11_REAR_LEFT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
// signal: @REAR_RIGHT_TIRE_PRESSURE_ro
#define PACMOD11_REAR_RIGHT_TIRE_PRESSURE_ro_CovFactor (4)
#define PACMOD11_REAR_RIGHT_TIRE_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (4)) )
#define PACMOD11_REAR_RIGHT_TIRE_PRESSURE_ro_fromS(x) ( ((x) * (4)) )
...
#define PACMOD11_PNEUMATIC_SUPPLY_PRESSURE_ro_CovFactor (8)
#define PACMOD11_PNEUMATIC_SUPPLY_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (8)) )
#define PACMOD11_PNEUMATIC_SUPPLY_PRESSURE_ro_fromS(x) ( ((x) * (8)) )
// signal: @BRAKE_CIRCUIT_1_PRESSURE_ro
#define PACMOD11_BRAKE_CIRCUIT_1_PRESSURE_ro_CovFactor (8)
#define PACMOD11_BRAKE_CIRCUIT_1_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (8)) )
#define PACMOD11_BRAKE_CIRCUIT_1_PRESSURE_ro_fromS(x) ( ((x) * (8)) )
// signal: @BRAKE_CIRCUIT_2_PRESSURE_ro
#define PACMOD11_BRAKE_CIRCUIT_2_PRESSURE_ro_CovFactor (8)
#define PACMOD11_BRAKE_CIRCUIT_2_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (8)) )
#define PACMOD11_BRAKE_CIRCUIT_2_PRESSURE_ro_fromS(x) ( ((x) * (8)) )
// signal: @PARK_TRAILER_AIR_PRESSURE_ro
#define PACMOD11_PARK_TRAILER_AIR_PRESSURE_ro_CovFactor (8)
#define PACMOD11_PARK_TRAILER_AIR_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (8)) )
#define PACMOD11_PARK_TRAILER_AIR_PRESSURE_ro_fromS(x) ( ((x) * (8)) )
// signal: @POWERTRAIN_AIR_PRESSURE_ro
#define PACMOD11_POWERTRAIN_AIR_PRESSURE_ro_CovFactor (8)
#define PACMOD11_POWERTRAIN_AIR_PRESSURE_ro_toS(x) ( (uint8_t) ((x) / (8)) )
#define PACMOD11_POWERTRAIN_AIR_PRESSURE_ro_fromS(x) ( ((x) * (8)) )
...
// signal: @FUEL_RATE_ro
#define PACMOD11_FUEL_RATE_ro_CovFactor (0.050000)
#define PACMOD11_FUEL_RATE_ro_toS(x) ( (uint16_t) (((x) - (0.000000)) / (0.050000)) )
#define PACMOD11_FUEL_RATE_ro_fromS(x) ( (((x) * (0.050000)) + (0.000000)) )
